...
VOS_INT32 diag_RegRead(VOS_UINT32 u32RegAddr,ENADDRTYPE enAddrType, VOS_UINT32 *pu32Value)
{
    ...
    {
        case ADDRTYPE8BIT:
            *pu32Value = *((volatile VOS_UINT8 *)u32RegAddr);/* [false alarm]:屏蔽Fortify */
            return OK;

        case ADDRTYPE16BIT:
            *pu32Value = *((volatile VOS_UINT16 *)u32RegAddr);/* [false alarm]:屏蔽Fortify */
            return OK;

        case ADDRTYPE32BIT:
            *pu32Value = *((volatile VOS_UINT32 *)u32RegAddr);/* [false alarm]:屏蔽Fortify */
            return OK;
...
VOS_INT32 diag_RegWrite(VOS_UINT32 u32RegAddr,ENADDRTYPE enAddrType, VOS_UINT32 u32Value)
{
    ...
    {
        case ADDRTYPE8BIT:
            *((volatile VOS_UINT8 *)u32RegAddr) = (VOS_UINT8)u32Value;/* [false alarm]:屏蔽Fortify */
            return OK;

        case ADDRTYPE16BIT:
            *((volatile VOS_UINT16 *)u32RegAddr) = (VOS_UINT16)u32Value;/* [false alarm]:屏蔽Fortify */
            return OK;
