...
OM_FUNCID_PROC_STRU g_astAcpuOmFuncIdProcTbl[OM_FUNCID_MAX_NUM] =
{
    ...
    {Om_AcpuBbpConfigMsgProc,     OM_BBP_FUNC,      LEVEL_NORMAL}
};
...
VOS_VOID OM_AutoConfigProc(VOS_VOID)
{
    ...
    (VOS_VOID)DRV_FILE_LSEEK(lCfgFile, 0, 0);
    ...
    for(;;)
    {
        ...
        if (ulMsgLen != (VOS_UINT32)DRV_FILE_READ((VOS_CHAR*)(pstMsgBlk->aucValue), sizeof(VOS_CHAR), (VOS_UINT32)ulMsgLen, lCfgFile))
        {
...
/*****************************************************************************
 ...
 History         : ---
    ...
    Modification : Created function
 *****************************************************************************/
VOS_VOID OM_AcpuVerQryDbgInfoReqSnd(VOS_VOID)
{
    MsgBlock       *pMsg;
    ...
    *(VOS_UINT16*)(pMsg->aucValue) = OM_VERSION_DEBUG_INFO_REQ;
