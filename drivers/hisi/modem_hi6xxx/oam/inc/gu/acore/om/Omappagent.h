...
#define OM_VERSION_DEBUG_INFO_REQ   (0x000D)
...
#endif
#define OM_VERSION_DEBUG_INFO_CNF   (0x030f)
...
typedef struct
{
    VOS_UINT32  ulVerQryRcvCnt;
    VOS_UINT32  ulAllocMemFail;
    VOS_UINT32  ulDrvErr;
    VOS_UINT32  ulLenErr;
    VOS_UINT32  ulSucc;
}OM_VERSION_QRY_DEBUG_INFO_STRU;
...
typedef struct
{
    ...
    VOS_UINT16                          usPrimId;                           /* 指示当前的消息类型 */
    VOS_UINT16                          usReserve;                          /* 保留 */
    OM_VERSION_QRY_DEBUG_INFO_STRU      stVerDebugInfo;
}OM_VERSION_QRY_DEBUG_INFO_CNF_STRU;
