...
#define THRESHOLD_DURATION_CLICK	500/*click threshold*/
            ...
            if(fpc1020->nav.throw_event == 0)
            {
                ...
                if (key_code)
                {
                    active = 1;
                    {
                        ...
                        {
                            case KEY_UP:
                                pr_info("[FPC/DPAD]  key up\n");
                                break;
                            case KEY_DOWN:
                                pr_info("[FPC/DPAD]  key down\n");
                                break;
                            case KEY_LEFT:
                                pr_info("[FPC/DPAD]  key left\n");
                                break;
                            case KEY_RIGHT:
                                pr_info("[FPC/DPAD]  key right\n");
                                break;
                            default:
                                break;
                        }
				...
				&& ((deviation <= THRESHOLD_RANGE_DOUBLE_TAP )||((dy == fpc1020->nav.move_pre_y)&& (dx==fpc1020->nav.move_pre_x))))
                    {
			            ...
			            duration < THRESHOLD_DURATION_CLICK && fpc1020->nav.throw_event_move == 0)
                    {
