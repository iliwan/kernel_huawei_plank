...
typedef enum tagIPC_INT_LEV_E
{
   ...
   /* 定义MCU IPC跨核消息中断源bit位置 */
    ...
    IPC_ACPU_INT_SRC_CCPU_PM_OM                     = 22,       /* bit22，CCPU发给ACPU的PMOM中断,触发写文件, 姚国才 */
   ...
   IPC_CCPU_INT_SRC_DSP_RCM_PUB_MBX                 = 5,        /*bit5,提供给RCM邮箱使用*/
