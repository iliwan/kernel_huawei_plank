...
typedef struct
{
    VOS_UINT16        AllocPid;           /* Pid who alloc the memory */
    VOS_UINT16       AllocNum;        /* alloc num */
}VOS_ALLOC_MEM_PID_INFO;
...
typedef struct
{
    ...
    VOS_UINT32             BuysBlockNumber;/* the number of buys block*/
    VOS_UINT32             PidNumber;/* the number of buys block*/
    VOS_ALLOC_MEM_PID_INFO  PidInfo[VOS_PID_BUTT-VOS_PID_DOPRAEND];/*list of pid info*/

} VOS_MEM_CTRL_DUMP_BLOCK;

typedef struct
{
    VOS_UINT32        MsgMemOffset;          /* msg  memory dump info offset */
    VOS_UINT32        MsgMemSize;           /* msg  memory dump info size*/
    VOS_UINT32        MsgMemBlockNum;   /* msg  memory dump block num*/
    VOS_UINT32        SimpleMemOffset;    /* simple memory  dump info offset*/
    VOS_UINT32        SimpleMemSize;     /* simple memory  dump info size*/
    VOS_UINT32        SimpleMemBlockNum;   /* msg  memory dump block num*/
}VOS_MEM_GLOBAL_DUMP_INFO;
