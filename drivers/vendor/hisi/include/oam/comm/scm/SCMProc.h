...
#define SCM_CODER_DST_THRESHOLD_GU  (4)             /* GU编码目的通道阈值，单位KB */

#define SCM_CODER_DST_THRESHOLD_L   (4)             /* L编码目的通道阈值，单位KB */

#define SCM_CODER_DST_GTHRESHOLD    ((4*1024)+8)    /* 编码源通道仲裁阈值 */

#define SCM_DECODER_DST_THRESHOLD   (1)             /* 解码目的通道阈值, 单位HDLC帧 */
...
#define SCM_MALLOC_MAX_INDEX    9           /*page_size 为4K*/
