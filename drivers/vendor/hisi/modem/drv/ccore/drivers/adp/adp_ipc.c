...
BSP_S32 DRV_SPIN_TRYLOCK(BSP_U32 u32SignalNum){
...
s32 BSP_IPC_SpinLock_IrqSave(BSP_U32 u32SignalNum, unsigned long *flags)
{
	local_irq_save(*flags);
	return  bsp_ipc_spin_lock(u32SignalNum);
	
}
s32	BSP_IPC_SpinUnLock_IrqRestore(BSP_U32 u32SignalNum,unsigned long *flags)
{
	s32 ret = 0;
