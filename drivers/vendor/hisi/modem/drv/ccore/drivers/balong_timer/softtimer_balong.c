...
/*lint --e{525,537,539,628,666,718,746,752,760,830,958}*/
#ifdef __KERNEL__
...
{
#endif
/*lint --e{129, 63, 64, 409, 49, 52, 502, 574, 569 ,613 ,628,550} */
...
void bsp_softtimer_add(struct softtimer_list * timer)
{
    ...
    else
    {
		...
		/*lint -restore +e10*//*lint -restore +e26*/
