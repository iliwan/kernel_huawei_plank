...
void show_sram_status(void)
{
	...
	printf("%-30s%10lx%10p%10x\n", "SRAM_TOP_RESERVE_ADDR", SRAM_V2P(SRAM_TOP_RESERVE_ADDR),(void *)SRAM_TOP_RESERVE_ADDR, SRAM_TOP_RESERVE_SIZE);/*lint !e778 */
...
void show_shared_ddr_status(void)
{
	...
	printf("%-30s%10s%10s%10s\n", "name", "phy addr", "virt addr", "size");
	printf("%-30s%10lx%10p%10x\n", "SHM_MEM_APPA9_PM_BOOT_ADDR", SHD_DDR_V2P(SHM_MEM_APPA9_PM_BOOT_ADDR), (void *)SHM_MEM_APPA9_PM_BOOT_ADDR, SHM_MEM_APPA9_PM_BOOT_SIZE);
	printf("%-30s%10lx%10p%10x\n", "SHM_MEM_MDMA9_PM_BOOT_ADDR", SHD_DDR_V2P(SHM_MEM_MDMA9_PM_BOOT_ADDR), (void *)SHM_MEM_MDMA9_PM_BOOT_ADDR, SHM_MEM_MDMA9_PM_BOOT_SIZE);
    ...
    printf("%-30s%10lx%10p%10x\n", "SHM_MEM_PM_OM_ADDR", SHD_DDR_V2P(SHM_MEM_PM_OM_ADDR), SHM_MEM_PM_OM_ADDR, SHM_MEM_PM_OM_SIZE);
    printf("%-30s%10lx%10p%10x\n", "SHM_MEM_M3PM_LOG_ADDR", SHD_DDR_V2P(SHM_MEM_M3PM_LOG_ADDR), SHM_MEM_M3PM_LOG_ADDR, SHM_MEM_M3PM_LOG_SIZE);
