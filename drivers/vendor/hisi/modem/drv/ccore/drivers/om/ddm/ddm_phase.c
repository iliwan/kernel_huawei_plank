...
#define PHASE_BOOT_POOL_ADDR    ((u32)SHM_DDM_LOAD_ADDR + sizeof(DDM_POOL_CTRL))
...
static int ddm_phase_score(DDM_POOL_CTRL* pPhaseCtrl ,const char* phaseName,unsigned int param)
{
    ...
    pPhaseData->taskId = (unsigned int)taskIdSelf();    
