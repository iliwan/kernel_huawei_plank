...
u32 bsp_task_swt_set(u32 set_swt,u32 period)
{
    ...
    if(BSP_SYSVIEW_SWT_ON == set_swt)
    {
        ...
        else
        {
            ...
            osl_task_init("task_view_task", 150, 8192,  task_view_task, NULL, (u32 *)(&(task_info_stru.task_id)) );
            if(task_info_stru.task_id != 0)
            {
        ...
        /*lint -save -e64*/
        bsp_dump_register_sysview_hook(DUMP_SYSVIEW_TASKSWITCH, task_swt_read_cb_done);
         /*lint -restore +e64*/
    }
    else
    {
...
u32 bsp_int_lock_set(u32 set_swt,u32 period)
{
    ...
    if(BSP_SYSVIEW_SWT_ON == set_swt)
    {
        ...
        else
        {
            ...
            osl_task_init("int_lock_task", 150, 8192,  int_lock_view_task, NULL, (u32 *)(&(int_lock_stru.task_id)) );
        ...
        /*lint -save -e64*/
        bsp_dump_register_sysview_hook(DUMP_SYSVIEW_INTLOCK, int_lock_read_cb_done);
        /*lint -restore +e64*/
    }
    else
    {
