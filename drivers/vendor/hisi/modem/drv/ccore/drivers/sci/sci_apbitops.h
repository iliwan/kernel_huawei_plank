 ...
 * 
 */
#define BIT_MASK(__bws) ((u32)(((bw ## __bws)==32)?0xFFFFFFFF:((1U << (bw ## __bws)) - 1)) << (bs ## __bws))
 ...
 * 
 */
#define BIT_GET(__datum, __bws) ((u32)(((__datum) & ((u32) BIT_MASK(__bws))) >> (bs ## __bws)))
 ...
 * 
 */
#define BIT_SET(__datum, __bws, __val) ((__datum) = ((u32) (__datum) & (u32)~(BIT_MASK(__bws))) | \
                                        ((u32) ((u32)(__val) << (u32)(bs ## __bws)) & (BIT_MASK(__bws))))
