...
#include "hi_efuse.h"
/*lint --e{527,545,718,732,734,746,760,774,801,830}*/
...
int sss_test1()
{
	...
	data_in = (char*)malloc((unsigned int)data_in_len);
	decrypto_resul = (char*)malloc((unsigned int)data_in_len);
	out_data = (char*)malloc((unsigned int)out_data_len);
