...
#define SOCP_REG_BASEADDR           HI_SOCP_REGBASE_ADDR
...
#define SOCP_CHECK_INIT() \
    do {\
        ...
        {\
            printf("the module has not been initialized!\n"); \
...
#define SOCP_CHECK_CHAN_TYPE(para, type) \
    do {\
        if (type != para)\
        {\
            printf("the Chan's Type is invalid!\n"); \
...
#define SOCP_CHECK_8BYTESALIGN(para) \
    do {\
        if (0 != (para % 8))\
        {\
            printf("the parameter is not 8 bytes aligned!\n"); \
...
#define SOCP_CHECK_ENCSRC_CHNMODE(para) \
    do {\
        ...
        {\
            printf("encoder src channele mode is %d, which is invalid!\n", para); \
            return BSP_ERR_SOCP_INVALID_PARA; \
        } \
    } while (0)
...
#define SOCP_CHECK_DECSRC_CHNMODE(para) \
    do {\
        ...
        {\
            printf("decoder dst channele mode is %d, which is invalid!\n", para); \
            return BSP_ERR_SOCP_INVALID_PARA; \
        } \
    } while (0)
...
#define SOCP_CHECK_CHAN_PRIORITY(para) \
    do {\
        ...
        {\
            printf("encoder src channele priority is %d, which is invalid!\n", para); \
            return BSP_ERR_SOCP_INVALID_PARA; \
        } \
    } while (0)
...
#define SOCP_CHECK_DATA_TYPE(para) \
    do {\
        ...
        {\
            printf("channel data type is %d, which is invalid!\n", para); \
            return BSP_ERR_SOCP_INVALID_PARA; \
        } \
    } while (0)
...
#define SOCP_CHECK_ENCDST_SET(id) \
    do {\
        ...
        {\
            printf("encoder dst[%d] set failed!\n", id); \
            return BSP_ERR_SOCP_INVALID_CHAN; \
        } \
    } while (0)
...
#define SOCP_CHECK_DECSRC_SET(id) \
    do {\
        ...
        {\
            printf("decoder[%d] src set failed!\n", id); \
            return BSP_ERR_SOCP_INVALID_CHAN; \
        } \
    } while (0)
...
#define SOCP_CHECK_DECDST_ALLOC(id) \
    do {\
        ...
        {\
            printf("decoder dst[%d] alloc failed!\n", id); \
            return BSP_ERR_SOCP_INVALID_CHAN; \
        } \
    } while (0)
...
#define SOCP_CHECK_DATA_TYPE_EN(param) \
    do {\
        ...
        {\
            printf("the data type en is valid, para is %d!\n", param); \
            return BSP_ERR_SOCP_INVALID_PARA; \
        } \
    } while (0)
...
#define SOCP_CHECK_ENC_DEBUG_EN(param) \
    do {\
        ...
        {\
            printf("the enc src debug en is invalid, para is %d!\n", param); \
            return BSP_ERR_SOCP_INVALID_PARA; \
        } \
    } while (0)
