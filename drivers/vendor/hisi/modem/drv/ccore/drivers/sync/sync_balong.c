...
*
*****************************************************************************/
s32 BSP_SYNC_Lock(SYNC_MODULE_E u32Module, u32 *pState, u32 u32TimeOut)
{
	unsigned long flag;
	u32 tick_end=0;
	u32 tick_begin=0;
...
*
*****************************************************************************/
s32 BSP_SYNC_UnLock(SYNC_MODULE_E u32Module, u32 u32State)
{
	BSP_SYNC_Init();
...
*
*****************************************************************************/
s32 BSP_SYNC_Wait(SYNC_MODULE_E u32Module, u32 u32TimeOut)
{
...
*
*****************************************************************************/
s32 BSP_SYNC_Give(SYNC_MODULE_E u32Module)
{
	BSP_SYNC_Init();
	if(u32Module >= SYNC_MODULE_BUTT)
	{
