...
typedef struct
{
    ...
    unsigned int ac_icc_chnl;              /* sim detect icc channel */    
    unsigned int m3c_icc_chnl;              /* sim detect icc channel */
...
typedef struct RecData
{
    ...
    u16 usPrelen;
    u16 usStart;
    u16 *usOutBuf;     /*SCI DMA Rx Data Buffer Pointer*/	// for dma transfer
...
{
    CARD_HPD_STATUS_NORMAL,
    CARD_HPD_STATUS_LEAVE,
    CARD_HPD_STATUS_BUTTON,
}SCI_CARD_HPD_STATUS;
...
s32 I1_bsp_sci_atr_get(unsigned long * pulLen, u8 *pucATRData,SCI_ATRInfo* stSCIATRInfo);
