...
*/
/*lint --e{525,527,539,628,718,746,830}*/
...
#ifdef CONFIG_CIPHER
extern s32 cipher_init(void);
extern s32 bsp_acc_init(void);
#endif
#ifdef CONFIG_MODEM_PINTRL
extern void modem_pinctrl_init(void);
#endif
...
extern void k3_timer_init(void);
#endif
#include <bsp_rfile.h>
#include <bsp_pm_om.h>
...
extern void balong_pm_init(void);
#endif

extern int cshell_init(void);
...
extern int tcxo_init_configure(void);
extern void adp_timer_init(void);
extern void hwspinlock_init(void);
