...
{
    /* dpm interface */
    s32 (*pmu_pa_power_on)(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id);
    s32 (*pmu_pa_power_off)(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id);
    s32 (*pmu_rf_power_on)(PWC_COMM_MODEM_E modem_id);
    s32 (*pmu_rf_power_off)(PWC_COMM_MODEM_E modem_id);
    PWC_COMM_STATUS_E (*pmu_pa_power_status)(PWC_COMM_MODEM_E modem_id, PWC_COMM_MODE_E mode_id);
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
s32 bsp_pa_poweron(PWC_COMM_MODEM_E modem_id,PWC_COMM_MODE_E enCommMode);
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
s32 bsp_pa_poweroff(PWC_COMM_MODEM_E modem_id,PWC_COMM_MODE_E enCommMode);
...
/*****************************************************************************
 ...
 返 回 值  : 0 - 成功，非0 - 失败
*****************************************************************************/
PWC_COMM_STATUS_E bsp_get_pa_powerstatus(PWC_COMM_MODEM_E modem_id,PWC_COMM_MODE_E enCommMode);
