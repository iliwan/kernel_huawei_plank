...
typedef struct tagS_CONFIG_INFO_S
{
    ...
    UINT32              u32ShaSIndex;       //sha_s来源于KeyRam时，其在keyRam中的索引
    UINT32              u32ShaSLength;     //sha_s的长度
    void             *pSAddr;           //
}S_CONFIG_INFO_S;
...
typedef UINT32 CIPHER_KEY_LEN_E_U32;
typedef UINT32 CIPHER_KEY_OUTPUT_E_U32;
...
typedef struct tagKEY_CONFIG_INFO_S
{
    ...
    UINT32              u32ShaKeyIndex;     //sha_key来源于KeyRam时，其在keyRam中的索引
    void             *pKeySourceAddr;   //
}KEY_CONFIG_INFO_S;
...
typedef struct tagKDF_BDCONFIG_INFO_S
{
    ...
    UINT32              u32ShaKeyIndex;     //sha_key来源于KeyRam时，其在keyRam中的索引
    UINT32              u32ShaSIndex;       //sha_s来源于KeyRam时，其在keyRam中的索引
    UINT32              u32Length;         //KDF运算作为sha_s的长度
    UINT32              u32DestIndex;      //sha_result_sn在key_ram中的位置
...
#pragma pack(8)
    struct Data_Buff
    {
	    UINT8 BD_BUFF[BDQ_SIZE];
	    UINT8 RD_BUFF[RDQ_SIZE];
    };
#pragma pack()
...
#define CIPHER_NULL_PTR      ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_NULL_PTR))
#define CIPHER_NO_MEM        ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_NO_MEM))
#define CIPHER_NOT_INIT      ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_NOT_INIT))
#define CIPHER_FIFO_FULL     ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_FIFO_FULL))
#define CIPHER_INVALID_CHN   ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_INVALID_CHN))
#define CIPHER_INVALID_OPT   ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_INVALID_OPT))
#define CIPHER_ALIGN_ERROR   ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_ALIGN_ERROR))
#define CIPHER_PURGING       ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_PURGING))
#define CIPHER_TIME_OUT      ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_TIME_OUT))
#define CIPHER_INVALID_ENUM  ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_INVALID_ENUM))
#define CIPHER_INVALID_RD    ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_INVALID_RD))
#define CIPHER_RDQ_NULL      ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_RD_NULL))
#define CIPHER_INVALID_KEY   ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_INVALID_KEY))
#define CIPHER_CHECK_ERROR   ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_CHECK_ERROR))
#define CIPHER_BDLEN_ERROR   ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_BDLEN_ERROR))
#define CIPHER_INVALID_NUM   ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_INVALID_NUM))
#define CIPHER_NO_KEY        ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_NO_KEY))
#define CIPHER_KEYLEN_ERROR  ((INT32)(CIPHER_ERROR_BASE|CIPHER_ERR_CODE_KEYLEN_ERROR))
#define CIPHER_UNKNOWN_ERROR ((INT32)(CIPHER_ERROR_BASE|0xff))
