...
*   ×÷    Õß :  wuzechun
*
*   Ãè    Êö :  hsuart.c µÄÍ·ÎÄ¼ş
*
*   ĞŞ¸Ä¼ÇÂ¼ :  2011Äê6ÔÂ13ÈÕ  v1.00  wuzechun  ´´½¨
*
*************************************************************************/
...
#define UART_DEF_TET_2CHAR    0x10 /* FIFO ÖĞÓĞ2 ¸ö×Ö·û*/
#define UART_DEF_TET_ONEFOUR  0x20 /* FIFO ËÄ·ÖÖ®Ò»Âú*/
#define UART_DEF_TET_ONETWO   0x30 /* FIFO ¶ş·ÖÖ®Ò»Âú*/
...
/* ÉèÖÃLCR */
/* Í£Ö¹Î»ÉèÖÃ */
#define UART_DEF_LCR_STP2   0x04  /*ÔÚLCR bit[1:0]=0 µÄÌõ¼şÏÂÎª1.5 ¸öÍ£Ö¹Î»£¬·ñÔòÎª2 ¸öÍ£Ö¹Î»*/
#define UART_DEF_LCR_STP1   0x00  /*1¸öÍ£Ö¹Î»*/

#define UART_DEF_LCR_PEN    0x08 /* ÆæÅ¼Ğ£ÑéÊ¹ÄÜ*/
#define UART_DEF_LCR_EPS    0x10 /* ÆæÅ¼Ğ£ÑéÑ¡Ôñ*/

#define UART_DEF_PARITY_NONE 0x00 /* ÎŞÆæÅ¼Ğ£Ñé */

#define UART_DEF_LCR_DIVENABLE  0x80  /* ·ÖÆµ¼Ä´æÆ÷Ê¹ÄÜ */

/* ÉèÖÃÊı¾İÁ÷ÖĞµÄÃ¿¸ö×Ö·ûµÄ¸öÊı*/
