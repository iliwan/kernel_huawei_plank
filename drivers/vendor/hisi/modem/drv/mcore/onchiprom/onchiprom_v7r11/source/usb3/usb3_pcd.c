...
extern void usb3_bulk_out_transfer(void *pcd);
    ...
    case UDESC_DEVICE:
        {
            ...
            dev->bDeviceClass = USB_CLASS_COMM;
...
void usb3_bulk_in_transfer(void *dev, uint8_t response)
{
    usb3_pcd_t *pcd = (usb3_pcd_t *)dev;
    usb3_pcd_ep_t *ep = &pcd->in_ep;
    usb3_pcd_req_t *req = &ep->req;

    pcd->ss_bulk_buf[0] = response;

    /* req->actual = 0; */
    req->length = 1;
    req->bufdma = pcd->ss_bulk_buf;
    req->complete = usb3_bulk_out_transfer;
