...
#define PLATFORM_V7R2_ASIC      1
#define PLATFORM_V7R2_PORTING   2
#define PLATFORM_V7R2_EDA       3


#define FLASH_BOOT_ADDR        0xA0000000    /*bootload.bin文件在Flash中(boot模式下)的保存地址*/
...
#define BOOT_MODE_RESEV_1           (0x02<<SC_BOOTMODE_BITPOS)  /* V7R2未用 */
#define BOOT_MODE_RESEV_2           (0x03<<SC_BOOTMODE_BITPOS)  /* V7R2未用 */
...
#define BOOT_MODE_NAND              (0x07<<SC_BOOTMODE_BITPOS)
