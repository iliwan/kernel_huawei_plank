...
/*    VOS_INT                             iResult;*/
    ...
    if ((NV_OK != ulResult0)&&(NV_OK != ulResult1))
    {
    ...
    if ((VOS_TRUE != stModem0LcCtrl.ucLCEnableFlg)&&(VOS_TRUE != stModem1LcCtrl.ucLCEnableFlg))
    {
