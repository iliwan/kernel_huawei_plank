...
/* 通道参数 */
#define SLEEP_ABB_CHAN(enMode)          (g_stSleepChanPara.astModeBasicParam[enMode].usABBSwitch)
#define SLEEP_RF_CHAN(enMode)           (g_stSleepChanPara.astModeBasicParam[enMode].usRFSwitch)
#define SLEEP_TCXO_CHAN(enMode)         (g_stSleepChanPara.astModeBasicParam[enMode].usTCXOSwitch)
