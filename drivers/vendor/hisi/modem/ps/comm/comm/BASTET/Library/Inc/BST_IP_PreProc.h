...
#define BST_IP_ReadFromPcbPropertey(dst, src)\
                                         ...
                                         (dst)->usSndWscale = (src)->snd_wnd_scale;\
                                         (dst)->usRcvWscale = (src)->rcv_wnd_scale;\
                                         (dst)->ulTsRecentStamp \
                                                            = (src)->ts_recent_stamp;\
...
#define BST_IP_WriteToPcbPropertey(dst, src)\
                                         ...
                                         (dst)->snd_wnd     = (BST_UINT16)(src)->ulSndWnd;\
                                         (dst)->snd_wnd_scale \
                                                            = (BST_UINT16)(src)->usSndWscale;\
                                         (dst)->rcv_wnd_scale \
                                                            = (BST_UINT16)(src)->usRcvWscale;\
