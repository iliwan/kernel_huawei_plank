...
#endif
extern BST_IP_ERR_T BST_SRV_RcvTcpIpEvent( BST_IP_EVENT_STRU *pstEvent );
/******************************************************************************
   3 私有定义
******************************************************************************/
...
BST_VOID BST_IP_ApiSetPreprocWorking( BST_IP_PROTOCOL_TYPE usProtocol, BST_UINT16 usPortNum )
{
    BST_IP_PORT_PREPROC_STRU           *pstPortPreproc;
    BST_UINT32                          ulSpinlockCnt;
    ...
    BST_DBG_LOG1("BST_IP_ApiSetPreprocWorking usPortNum:%u", usPortNum);
}
...
BST_UINT32 BST_IP_ApiUpdateTrafficFlow( BST_UINT32 ulTrfcAction, BST_UINT32 ulTrfcFlow  )
{
    ...
    stEvent.enErrMsg                    = BST_IP_ERR_OK;
    stEvent.enId                        = LWIP_EVENT_OVERFLOW;
    stEvent.pstBuf                      = BST_NULL_PTR;
    stEvent.pstPcb                      = BST_NULL_PTR;
    stEvent.pvArg                       = &g_ulTrafficFlowCounter;
    stEvent.usSize                      = 0;
    ( BST_VOID )BST_SRV_RcvTcpIpEvent( &stEvent );
    BST_OS_SpinUnLock( &g_BstTotFlowSpinLock , ulSpinlockCnt );
    return BST_TRUE;
}
    ...
    const BST_INT32             lTcpLen )
{
    ...
    pstRubbishPcb->snd_wnd_scale    = 0;
    pstRubbishPcb->rcv_wnd_scale    = 0;
