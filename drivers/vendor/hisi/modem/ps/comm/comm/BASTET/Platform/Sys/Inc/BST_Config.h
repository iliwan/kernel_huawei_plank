...
#define BST_APP_THREAD_FLAG             ( 0x04U )
#else
#define BST_APP_THREAD_FLAG             ( 0x00U )
#endif
...
/*****************************************************************************
  4 ACOMM
*****************************************************************************/
#define BST_ACOM_PACKET_SIZE            ( 1024 )
...
#define BST_IP_MTU_SIZE                 ( ETH_MAX_MTU )
