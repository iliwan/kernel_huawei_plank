...
VOS_VOID  ST_IMS_NIC_ClrQ(VOS_VOID)
{
    ...
    if (0 != ulQCnt)
    {
        vos_printf("ST_IMS_NIC_ClrQ: ulQCnt = %d\n", ulQCnt);
    }
...
VOS_UINT32  ST_IMS_NIC_PrintData( VOS_UINT8 *pData, VOS_UINT16 usLen )
{
    ...
    {
        vos_printf("ST_IMS_NIC_PrintData: pData is NULL\n");
        return IMS_NIC_FAIL;
    }
...
VOS_UINT32 ST_IMS_NIC_UlCb(VOS_UINT8 *pData, VOS_UINT16 usLen, MODEM_ID_ENUM_UINT16 enModemId)
{
    ...
    {
        vos_printf("ST_IMS_NIC_UlCb: TTF_MemBlkAlloc fail");
    ...
    if (ulRslt != PS_SUCC)
    {
        vos_printf("ST_IMS_NIC_UlCb : TTF_LinkInsertTail fail!\n");
    }
    /*lint +e774*/

    vos_printf("ST_IMS_NIC_UlCb, ulQCnt = %d!\r\n", TTF_LinkCnt(UEPS_PID_IMSNIC, &g_stImsNicQ));
...
VOS_VOID ST_IMS_NIC_RegUlCb(VOS_VOID)
{
    ...
    {
        vos_printf("ST_IMS_NIC_RegUlCb: Reg UL CB fail!\n");
        return;
    }
...
VOS_UINT32 ST_IMS_NIC_UlSockV4Send(VOS_UINT8 *aucDstIpAddr, VOS_UINT8 *aucSrcIpAddr, VOS_UINT16 usImsNicPort, VOS_UINT8 *aucIpData, VOS_INT s_size)
{
    ...
    if (sock < 0)
    {
        vos_printf("ST_IMS_NIC_UlSockV4Send: Get socket failed!\n");
        return IMS_NIC_FAIL;
    }
    ...
    {
        vos_printf("ST_IMS_NIC_UlSockV4Send: bind socket failed!\n");
    ...
    vos_printf("ST_IMS_NIC_UlSockV4Send: ipcom_sendto count = %d !\n", count);
    ipcom_socketclose(sock);
    return IMS_NIC_SUCC;
}
...
VOS_UINT32 ST_IMS_NIC_UlSockV6Send(VOS_UINT8 *aucDstIpAddr, VOS_UINT8 *aucSrcIpAddr, VOS_UINT16 usImsNicPort, VOS_UINT8 *aucIpData, VOS_INT s_size)
{
    ...
    {
        vos_printf("ST_IMS_NIC_UlSockV6Send: bind socket failed!\n");
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    ...
    vos_printf("ST_IMS_NIC_UlSockV6Send: ipcom_sendto count = %d !\n", count);
    ipcom_socketclose(sock);
    return IMS_NIC_SUCC;
}
...
VOS_UINT32 ST_IMS_NIC_001_base(IMS_NIC_PDN_INFO_CONFIG_STRU *pstConfigInfo, VOS_UINT8 *aucDstIpAddr, VOS_UINT8 *aucSrcIpAddr)
{
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_001: config pdn fail! ulResult = %d\n", ulResult);
            return ulResult;
        }
    }
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_IMS_NIC_001: send data via socket fail!\n");
        return ulResult;
    }
    ...
    if ( ulQCnt != 1 )
    {
        vos_printf("ST_IMS_NIC_001, Fail! ulQCnt = %d!\r\n", ulQCnt);
        return IMS_NIC_FAIL;
    }
    ...
    {
        vos_printf("ST_IMS_NIC_001, Fail! Q is empty!\r\n");
        ST_IMS_NIC_ClrQ();
        return IMS_NIC_FAIL;
    }
    ...
    {
        vos_printf("ST_IMS_NIC_001, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
    ...
    {
        vos_printf("ST_IMS_NIC_001, Fail! data not match!\r\n");
    }
    else
    {
        vos_printf("ST_IMS_NIC_001, Succ!\r\n");
    }
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_001: del pdn fail! ulResult = %d\n", ulResult);
            return ulResult;
        }
    }
...
VOS_UINT32 ST_IMS_NIC_002_base(IMS_NIC_PDN_INFO_CONFIG_STRU *pstConfigInfo, VOS_UINT8 *aucDstIpAddr, VOS_UINT8 *aucSrcIpAddr)
{
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_002: config pdn fail! ulResult = %d\n", ulResult);
            return ulResult;
        }
    }
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_IMS_NIC_002: send data via socket fail!\n");
        return ulResult;
    }
    ...
    if ( ulQCnt != 1 )
    {
        vos_printf("ST_IMS_NIC_002, Fail! ulQCnt = %d!\r\n", ulQCnt);
        return IMS_NIC_FAIL;
    }
    ...
    if (pstTtfMem == VOS_NULL_PTR)
    {
        vos_printf("ST_IMS_NIC_002, Fail! Q is empty!\r\n");
        ST_IMS_NIC_ClrQ();
        return IMS_NIC_FAIL;
    }
    ...
    {
        vos_printf("ST_IMS_NIC_002, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
        TTF_MemFree(UEPS_PID_IMSNIC, pstTtfMem);
        ST_IMS_NIC_ClrQ();
        return IMS_NIC_FAIL;
    }
    ...
    {
        vos_printf("ST_IMS_NIC_002, Fail! data not match!\r\n");
    }
    else
    {
        vos_printf("ST_IMS_NIC_002, Succ!\r\n");
    }
...
VOS_UINT32 ST_IMS_NIC_003_base(IMS_NIC_PDN_INFO_CONFIG_STRU *pstConfigInfo, VOS_UINT8 *aucDstIpAddr, VOS_UINT8 *aucSrcIpAddr)
{
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_003: config pdn fail! ulResult = %d\n", ulResult);
            return ulResult;
        }
    }
    ...
    if (sock < 0)
    {
        vos_printf("ST_IMS_NIC_003: Get socket failed!\n");
        return IMS_NIC_FAIL;
    }
    ...
    if (ipcom_bind(sock, (struct Ip_sockaddr*) &stInAddr, sizeof(struct Ip_sockaddr)) < 0)
    {
        vos_printf("ST_IMS_NIC_003: bind socket failed!\n");
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    }
    ...
    vos_printf("ST_IMS_NIC_003: ipcom_sendto count = %d !\n", count);

    ulQCnt  = TTF_LinkCnt(UEPS_PID_IMSNIC, &g_stImsNicQ);
    if ( ulQCnt != 1 )
    {
        vos_printf("ST_IMS_NIC_004, Fail! ulQCnt = %d!\r\n", ulQCnt);
        return IMS_NIC_FAIL;
    }
    ...
    if (pstTtfMem == VOS_NULL_PTR)
    {
        vos_printf("ST_IMS_NIC_003, Fail! Q is empty!\r\n");
        ST_IMS_NIC_ClrQ();
        return IMS_NIC_FAIL;
    }
    ...
    if ( pstTtfMem->usUsed  != s_size + ST_IMS_NIC_HEADER_LEN)
    {
        vos_printf("ST_IMS_NIC_003, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
        TTF_MemFree(UEPS_PID_IMSNIC, pstTtfMem);
        ST_IMS_NIC_ClrQ();
        return IMS_NIC_FAIL;
    }
    ...
    if ( 0 != (VOS_MemCmp(aucIpData, pstTtfMem->pData + ST_IMS_NIC_HEADER_LEN, (VOS_UINT32)(pstTtfMem->usUsed - ST_IMS_NIC_HEADER_LEN))) )
    {
        vos_printf("ST_IMS_NIC_003, Fail! data not match!\r\n");
    }
    else
    {
        vos_printf("ST_IMS_NIC_003, Succ!\r\n");
    }
    ...
    if (read_set == IP_NULL)
    {
        vos_printf("ST_IMS_NIC_003: Prepare read set failed!\n");
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    }
    ...
    if (num == IP_SOCKERR)
    {
        vos_printf("ST_IMS_NIC_003: socketselect failed!\n");
        ipcom_free(read_set);
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    }
    ...
    {
        /* Timeout */
        vos_printf("ST_IMS_NIC_003: Timeout!\n");
        ipcom_free(read_set);
    ...
    {
        vos_printf("ST_IMS_NIC_003: error!\n");
        ipcom_free(read_set);
        ipcom_free(pucRcvBuf);
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    ...
    vos_printf("ST_IMS_NIC_003: ipcom_recvfrom count = %d !\n", count);
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_003: del pdn fail! ulResult = %d\n", ulResult);
            return ulResult;
        }
    }
    return IMS_NIC_SUCC;
...
VOS_UINT32 ST_IMS_NIC_004_base(IMS_NIC_PDN_INFO_CONFIG_STRU *pstConfigInfo, VOS_UINT8 *aucDstIpAddr, VOS_UINT8 *aucSrcIpAddr)
{
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_004: config pdn fail! ulResult = %d\n", ulResult);
            return ulResult;
        }
    }
    ...
    if (sock < 0)
    {
        vos_printf("ST_IMS_NIC_004: Get socket failed!\n");
        return IMS_NIC_FAIL;
    }
    ...
    if (ipcom_bind(sock, (struct Ip_sockaddr*)&in_addr6, sizeof(struct Ip_sockaddr_in6)) < 0)
    {
        vos_printf("ST_IMS_NIC_004: bind socket failed!\n");
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    }
    ...
    vos_printf("ST_IMS_NIC_004: ipcom_sendto count = %d !\n", count);
    ...
    if (pstTtfMem == VOS_NULL_PTR)
    {
        vos_printf("ST_IMS_NIC_004, Fail! Q is empty!\r\n");
        ST_IMS_NIC_ClrQ();
        return IMS_NIC_FAIL;
    }
    ...
    if ( pstTtfMem->usUsed  != s_size + ST_IMS_NIC_HEADER_V6_LEN)
    {
        vos_printf("ST_IMS_NIC_004, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
        TTF_MemFree(UEPS_PID_IMSNIC, pstTtfMem);
        ST_IMS_NIC_ClrQ();
        return IMS_NIC_FAIL;
    }
    ...
    if ( 0 != (VOS_MemCmp(aucIpData, pstTtfMem->pData + ST_IMS_NIC_HEADER_V6_LEN, (VOS_UINT32)(pstTtfMem->usUsed - ST_IMS_NIC_HEADER_V6_LEN))) )
    {
        vos_printf("ST_IMS_NIC_004, Fail! data not match!\r\n");
    }
    else
    {
        vos_printf("ST_IMS_NIC_004, Succ!\r\n");
    }
    ...
    if (read_set == IP_NULL)
    {
        vos_printf("ST_IMS_NIC_004: Prepare read set failed!\n");
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    }
    ipcom_memset(read_set, 0, sizeof(Ip_fd_set));
    ...
    if (num == IP_SOCKERR)
    {
        vos_printf("ST_IMS_NIC_004: socketselect failed!\n");
        ipcom_free(read_set);
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    }
    ...
    {
        /* Timeout */
        vos_printf("ST_IMS_NIC_004: Timeout!\n");
        ipcom_free(read_set);
        ipcom_free(pucRcvBuf);
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    ...
    {
        vos_printf("ST_IMS_NIC_004: error!\n");
        ipcom_free(read_set);
        ipcom_free(pucRcvBuf);
        ipcom_socketclose(sock);
        return IMS_NIC_FAIL;
    ...
    vos_printf("ST_IMS_NIC_004: ipcom_recvfrom count = %d !\n", count);
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_004: del pdn fail! ulResult = %d\n", ulResult);
            return ulResult;
        }
    }
    return IMS_NIC_SUCC;
...
VOS_VOID ST_IMS_NIC_005_base(IMS_NIC_PDN_INFO_CONFIG_STRU *pstConfigInfo, VOS_UINT8 *aucDstIpAddr, VOS_UINT8 *aucSrcIpAddr)
{
    ...
    if (pstConfigInfo != VOS_NULL_PTR)
    {
        ...
        if (IMS_NIC_SUCC != ulResult)
        {
            vos_printf("ST_IMS_NIC_005: config pdn fail! ulResult = %d\n", ulResult);
            return;
        }
    }
    ...
    if (sock < 0)
    {
        ...
        vos_printf("ST_IMS_NIC_005: Get socket failed!\n");
        return;
    }
    ...
    if (ipcom_bind(sock, (struct Ip_sockaddr*) &stInAddr, sizeof(struct Ip_sockaddr)) < 0)
    {
        vos_printf("ST_IMS_NIC_005: bind socket failed!\n");
        goto out;
    }
    ...
    for (i = 0; i < 5; i++)
    {
        ...
        vos_printf("ST_IMS_NIC_005: ipcom_sendto [%d] count = %d !\n", i, count);
    }
    ...
    if (read_set == IP_NULL)
    {
        vos_printf("ST_IMS_NIC_005: Prepare read set failed!\n");
        goto out;
    }
    ipcom_memset(read_set, 0, sizeof(Ip_fd_set));
    ...
    if ( ulQCnt != 5 )
    {
        vos_printf("ST_IMS_NIC_005, Fail! ulQCnt = %d!\r\n", ulQCnt);
        goto out;
    }
    ...
    for (i = 0; i < (VOS_INT)ulQCnt; i++)
    {
        ...
        if (pstTtfMem == VOS_NULL_PTR)
        {
            vos_printf("ST_IMS_NIC_005, Fail! Q is empty!\r\n");
            goto out;
        }

        if ( pstTtfMem->usUsed  != s_size + ST_IMS_NIC_HEADER_LEN)
        {
            vos_printf("ST_IMS_NIC_005, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
            TTF_MemFree(UEPS_PID_IMSNIC, pstTtfMem);
            goto out;
        }
        ...
        if ( 0 != (VOS_MemCmp(aucIpData, pstTtfMem->pData + ST_IMS_NIC_HEADER_LEN, (VOS_UINT32)(pstTtfMem->usUsed - ST_IMS_NIC_HEADER_LEN))) )
        {
            vos_printf("ST_IMS_NIC_005, Fail! data not match!\r\n");
        }
        else
        {
            vos_printf("ST_IMS_NIC_005, Succ!\r\n");
        }
    ...
    for (;;)
    {
        ...
        if (num == IP_SOCKERR)
        {
            vos_printf("ST_IMS_NIC_005: socketselect failed!\n");
            goto out;
        }
        ...
        {
            /* Timeout */
            vos_printf("ST_IMS_NIC_005: Timeout!\n");
            break;
        }
        /*lint -e573*/
        else if (num > 0 && IP_FD_ISSET(sock, read_set))
        ...
        {
            vos_printf("ST_IMS_NIC_005: error!\n");
            goto out;
        }
        ...
        if (count == s_size)
        {
            ...
            {
                vos_printf("recvfrom data match!\r\n");
                rcvNum++;
            }
        }

        vos_printf("ST_IMS_NIC_005: ipcom_recvfrom count = %d !\n", count);
    }

    if (rcvNum != 5)
    {
        vos_printf("recvfrom data num= %d not equal 5!\r\n", rcvNum);
        goto out;
    }
    vos_printf("ST_IMS_NIC_005: Pass!\r\n");
...
VOS_VOID ST_IMS_NIC_006(VOS_VOID)
{
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_IMS_NIC_006: config pdn fail! ulResult = %d\n", ulResult);
        return;
    }
    ...
    if (sock1 < 0)
    {
        vos_printf("ST_IMS_NIC_006: Get socket failed!\n");
        IMS_NIC_PdnInfoDel(5, 0);
    ...
    {
        vos_printf("ST_IMS_NIC_006: bind socket failed!\n");
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        vos_printf("sock1: ipcom_sendto [%d] count = %d !\n", i, count);
    }
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        vos_printf("sock2: ipcom_sendto [%d] count = %d !\n", i, count);
    }
    ...
    if (read_set == IP_NULL)
    {
        vos_printf("ST_IMS_NIC_006: Prepare read set failed!\n");
        goto out;
    }
    ipcom_memset(read_set, 0, sizeof(Ip_fd_set));
    ...
    if ( ulQCnt != 4 )
    {
        vos_printf("ST_IMS_NIC_006, Fail! ulQCnt = %d!\r\n", ulQCnt);
        goto out;
    }
    ...
    for (i = 0; i < (VOS_INT)ulQCnt; i++)
    {
        ...
        if (pstTtfMem == VOS_NULL_PTR)
        {
            vos_printf("ST_IMS_NIC_006, Fail! Q is empty!\r\n");
            goto out;
        }

        if ( pstTtfMem->usUsed  != s_size + ST_IMS_NIC_HEADER_LEN)
        {
            vos_printf("ST_IMS_NIC_006, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
            TTF_MemFree(UEPS_PID_IMSNIC, pstTtfMem);
            goto out;
        }
        ...
        {
            vos_printf("ST_IMS_NIC_006, Fail! data not match!\r\n");
        }
        else
        {
            vos_printf("rcv :ip & udp hdr :");
            ST_IMS_NIC_PrintData(pstTtfMem->pData, ST_IMS_NIC_HEADER_LEN);
        }
    ...
    for (;;)
    {
        ...
        if (num == IP_SOCKERR)
        {
            vos_printf("sock1: socketselect failed!\n");
            goto out;
        }
        ...
        if (count == s_size)
        {
            ...
            {
                vos_printf("ST_IMS_NIC_006: sock1, Fail! data not match!\r\n");
            }
            else
            {
                vos_printf("sock1, data match!\r\n");
                rcvNum++;
            }
        }

        vos_printf("ST_IMS_NIC_006: ipcom_recvfrom from sock1 count = %d !\n", count);
    }

    vos_printf("rcv data from sock1, rcvNum= %d!\r\n", rcvNum);
    if (rcvNum != 2)
    {
        goto out;
    }
    ...
    for (;;)
    {
        ...
        if (num == IP_SOCKERR)
        {
            vos_printf("sock2: socketselect failed!\n");
            goto out;
        }
        ...
        if (count == s_size)
        {
            ...
            {
                vos_printf("ST_IMS_NIC_006:sock2, Fail! data not match!\r\n");
            }
            else
            {
                vos_printf("sock2, data match!\r\n");
                rcvNum++;
            }
        }

        vos_printf("sock2: ipcom_recvfrom from sock2 count = %d !\n", count);
    }

    if (rcvNum != 2)
    {
        vos_printf("recvfrom data num= %d not equal 2!\r\n", rcvNum);
        goto out;
    }
    vos_printf("ST_IMS_NIC_006: Pass!\r\n");
...
VOS_VOID ST_IMS_NIC_007(VOS_VOID)
{
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_IMS_NIC_007: config pdn fail! ulResult = %d\n", ulResult);
        return;
    }
    ...
    vos_printf("ST_IMS_NIC_007:first config MinPort = %d, MaxPort = %d\n", usExpectMinPort, usExpectMaxPort);

    if ((usMinPort1 != usExpectMinPort) || (usMaxPort1 != usExpectMaxPort))
    {
        vos_printf("ST_IMS_NIC_007: config socket port fail!\n");
        return;
    }
    ...
    vos_printf("ST_IMS_NIC_007:sec config MinPort = %d, MaxPort = %d\n", usExpectMinPort, usExpectMaxPort);

    if ((usMinPort1 != usExpectMinPort) || (usMaxPort1 != usExpectMaxPort))
    {
        vos_printf("ST_IMS_NIC_007:socket port can not config twice!\n");
        return;
    }
    ...
    if (sock1 < 0)
    {
        vos_printf("ST_IMS_NIC_007: Get socket1 failed!\n");
        IMS_NIC_PdnInfoDel(ucRabId1, 0);
    ...
    {
        vos_printf("ST_IMS_NIC_007: bind socket1 failed!\n");
        ipcom_socketclose(sock1);
        IMS_NIC_PdnInfoDel(ucRabId1, 0);
        IMS_NIC_PdnInfoDel(ucRabId2, 0);
        return;
    ...
    if (sock2 < 0)
    {
        vos_printf("ST_IMS_NIC_007: Get socket2 failed!\n");
        ipcom_socketclose(sock1);
        IMS_NIC_PdnInfoDel(ucRabId1, 0);
        IMS_NIC_PdnInfoDel(ucRabId2, 0);
        return;
    ...
    {
        vos_printf("ST_IMS_NIC_007: bind socket2 failed!\n");
        goto out;
    }
    ...
    if (read_set == IP_NULL)
    {
        vos_printf("ST_IMS_NIC_007: Prepare read set failed!\n");
        goto out;
    }
    ipcom_memset(read_set, 0, sizeof(Ip_fd_set));
    ...
    if ( ulQCnt != 4 )
    {
        vos_printf("ST_IMS_NIC_007, Fail! ulQCnt = %d!\r\n", ulQCnt);
        goto out;
    }
    ...
    for (i = 0; i < (VOS_INT)ulQCnt; i++)
    {
        ...
        if (pstTtfMem == VOS_NULL_PTR)
        {
            vos_printf("ST_IMS_NIC_007, Fail! Q is empty!\r\n");
            goto out;
        }

        if ( pstTtfMem->usUsed  != s_size + ST_IMS_NIC_HEADER_V6_LEN)
        {
            vos_printf("ST_IMS_NIC_007, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
            TTF_MemFree(UEPS_PID_IMSNIC, pstTtfMem);
            goto out;
        }
        ...
        {
            vos_printf("ST_IMS_NIC_007, Fail! UL data not match!\r\n");
        }
        else
        {
            vos_printf("rcv :ip & udp hdr :");
    ...
    for (;;)
    {
        ...
        if (count == s_size)
        {
            ...
            if ( 0 != (VOS_MemCmp(aucIpData1, pucRcvBuf, (VOS_UINT32)count)) )
            {
                vos_printf("sock1, Fail! DL data not match!\r\n");
            }
            else
            {
                vos_printf("sock1, data match!\r\n");
        ...
        vos_printf("sock1: ipcom_recvfrom from sock1 count = %d !\n", count);
    }
    ...
    for (;;)
    {
        ...
        if (count == s_size)
        {
            ...
            if ( 0 != (VOS_MemCmp(aucIpData2, pucRcvBuf, (VOS_UINT32)count)) )
            {
                vos_printf("sock2, Fail! DL data not match!\r\n");
            }
            else
            {
                vos_printf("sock2, data match!\r\n");
    ...
    vos_printf("ST_IMS_NIC_007: Pass!\r\n");
...
VOS_VOID ST_IMS_NIC_008(VOS_VOID)
{
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("config pdn fail! ulResult = %d\n", ulResult);
        return;
    }
    ...
    if (ipcom_bind(sock2, (struct Ip_sockaddr*)&in_addr6, sizeof(struct Ip_sockaddr_in6)) < 0)
    {
        vos_printf("bind socket2 failed!\n");
        goto out;
    }
    ...
    if (read_set == IP_NULL)
    {
        vos_printf("Prepare read set failed!\n");
        goto out;
    }
    ipcom_memset(read_set, 0, sizeof(Ip_fd_set));
    ...
    if ( ulQCnt != 4 )
    {
        vos_printf("ST_IMS_NIC_008, Fail! ulQCnt = %d!\r\n", ulQCnt);
        goto out;
    }
    ...
    for (i = 0; i < (VOS_INT)ulQCnt; i++)
    {
        ...
        if (pstTtfMem == VOS_NULL_PTR)
        {
            vos_printf("ST_IMS_NIC_008, Fail! Q is empty!\r\n");
            goto out;
        }
        ...
        if (IMS_NIC_IPV4_VERSION == ucIpType)
        {
            if ( pstTtfMem->usUsed  != s_size + ST_IMS_NIC_HEADER_LEN)
            {
                vos_printf("ST_IMS_NIC_008, Fail! data len not match!pstTtfMem->usUsed = %d\r\n", pstTtfMem->usUsed);
                TTF_MemFree(UEPS_PID_IMSNIC, pstTtfMem);
                goto out;
            }
            ...
            if ( 0 != (VOS_MemCmp(aucIpData1, pstTtfMem->pData + ST_IMS_NIC_HEADER_LEN, (VOS_UINT32)(pstTtfMem->usUsed - ST_IMS_NIC_HEADER_LEN -1))) )
            {
                vos_printf("ST_IMS_NIC_008, Fail! UL IPV4 data not match!\r\n");
            }
            else
            {
                vos_printf("rcv :ip & udp hdr :");
        ...
        else if (IMS_NIC_IPV6_VERSION == ucIpType)
        {
            ...
            if ( 0 != (VOS_MemCmp(aucIpData1, pstTtfMem->pData + ST_IMS_NIC_HEADER_V6_LEN, (VOS_UINT32)(pstTtfMem->usUsed - ST_IMS_NIC_HEADER_V6_LEN -1))) )
            {
                vos_printf("ST_IMS_NIC_008, Fail! UL IPV6 data not match!\r\n");
            }
            else
            {
                vos_printf("rcv :ip & udp hdr :");
    ...
    for (;;)
    {
        ...
        if (count == s_size)
        {
            ...
            if ( 0 != (VOS_MemCmp(aucIpData2, pucRcvBuf, (VOS_UINT32)count)) )
            {
                vos_printf("sock2, Fail! UL data not match!\r\n");
            }
            else
            {
                vos_printf("sock2, data match!\r\n");
    ...
    vos_printf("ST_IMS_NIC_008: Pass!\r\n");
...
VOS_VOID ST_IMS_NIC_009(VOS_VOID)
{
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_IMS_NIC_009: config pdn fail! ulResult = %d\n", ulResult);
        return;
    }
...
VOS_VOID ST_IMS_NIC_DEL(VOS_UINT8 ucRabId, VOS_UINT8 ucModemId)
{
    ...
    vos_printf("ST_IMS_NIC_DEL Result %d \n", ulRslt);
}
...
VOS_VOID ST_IMS_NIC_CFG_001(VOS_VOID)
{
    ...
    vos_printf("ST_IMS_NIC_CFG_001 Result %d \n", ulRslt);
}
...
VOS_VOID ST_IMS_NIC_CFG_002(VOS_VOID)
{
    ...
    vos_printf("ST_IMS_NIC_CFG_002 Result1 %d \n", ulRslt);
...
VOS_VOID ST_IMS_NIC_CFG_003(VOS_VOID)
{
    ...
    vos_printf("ST_IMS_NIC_CFG_003 Result1 %d \n", ulRslt);
...
VOS_VOID ST_IMS_NIC_CFG_004(VOS_VOID)
{
    ...
    VOS_UINT16                          ausDnsPrimV6_rab6[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 1};
    VOS_UINT16                          ausDnsSecV6_rab6[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 2};

    VOS_UINT8                           aucIpV4_rab6[]       = {192, 168, 30, 6};
    VOS_UINT16                          ausIpV6_rab6[]       = {0x2002, 0, 0, 0, 0, 0, 0x30,6};

    VOS_UINT8                           aucDnsPrimV4_rab7[]  = {192, 168, 22, 7};
    VOS_UINT8                           aucDnsSecV4_rab7[]   = {192, 168, 22, 8};
    VOS_UINT16                          ausDnsPrimV6_rab7[]  = {0x2002, 0, 1, 0, 0, 0, 0x22, 7};
    VOS_UINT16                          ausDnsSecV6_rab7[]   = {0x2002, 0, 0, 1, 0, 0, 0x22, 8};

    VOS_UINT8                           aucIpV4_rab7[]       = {192, 168, 30, 7};
    VOS_UINT16                          ausIpV6_rab7[]       = {0x2002, 0, 0, 0, 1, 0, 0x30, 7};
    ...
    vos_printf("ST_IMS_NIC_CFG_004 Result5 %d \n", ulRslt);

    ulRslt = IMS_NIC_PdnInfoConfig(&stConfigInfo_rab6);

    vos_printf("ST_IMS_NIC_CFG_004 Result6 %d \n", ulRslt);

    ulRslt = IMS_NIC_PdnInfoConfig(&stConfigInfo_rab7);

    vos_printf("ST_IMS_NIC_CFG_004 Result7 %d \n", ulRslt);
...
VOS_VOID ST_IMS_NIC_CFG_005(VOS_VOID)
{
    ...
    VOS_UINT16                          ausDnsPrimV6_rab6[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x16};
    VOS_UINT16                          ausDnsSecV6_rab6[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x26};
    ...
    VOS_UINT16                          ausDnsPrimV6_rab7[]  = {0x2002, 0, 1, 0, 0, 0, 0x22, 0x17};
    VOS_UINT16                          ausDnsSecV6_rab7[]   = {0x2002, 0, 0, 1, 0, 0, 0x22, 0x27};
...
VOS_VOID ST_IMS_NIC_CFG_006(VOS_VOID)
{
    ...
    VOS_UINT16                          ausIpV6_rab9[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 6};
    ...
    VOS_UINT16                          ausIpV6_rab10[]       = {0x2002, 0, 0, 0, 1, 0, 0x30, 7};
    ...
    VOS_UINT16                          ausIpV6_rab12[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 6};
    ...
    VOS_UINT16                          ausIpV6_rab13[]       = {0x2002, 0, 0, 0, 1, 0, 0x30, 7};
    ...
    VOS_UINT16                          ausIpV6_rab15[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 6};
    ...
    VOS_UINT16                          ausIpV6_rab16[]       = {0x2002, 0, 0, 0, 1, 0, 0x30, 7};
...
VOS_VOID ST_IMS_NIC_CFG_007(VOS_VOID)
{
    ...
    VOS_UINT16                          ausDnsPrimV6_rab8[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x18};
    VOS_UINT16                          ausDnsSecV6_rab8[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x28};
    VOS_UINT8                           aucIpV4_rab8[]       = {192, 168, 30, 8};
    VOS_UINT16                          ausIpV6_rab8[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 8};

    VOS_UINT8                           aucDnsPrimV4_rab9[]  = {192, 168, 22, 19};
    VOS_UINT8                           aucDnsSecV4_rab9[]   = {192, 168, 22, 29};
    VOS_UINT16                          ausDnsPrimV6_rab9[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x19};
    VOS_UINT16                          ausDnsSecV6_rab9[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x29};
    VOS_UINT8                           aucIpV4_rab9[]       = {192, 168, 30, 9};
    VOS_UINT16                          ausIpV6_rab9[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 9};

    VOS_UINT8                           aucDnsPrimV4_rab10[]  = {192, 168, 22, 20};
    VOS_UINT8                           aucDnsSecV4_rab10[]   = {192, 168, 22, 30};
    VOS_UINT16                          ausDnsPrimV6_rab10[]  = {0x2002, 0, 1, 0, 0, 0, 0x22, 0x20};
    VOS_UINT16                          ausDnsSecV6_rab10[]   = {0x2002, 0, 0, 1, 0, 0, 0x22, 0x30};
    VOS_UINT8                           aucIpV4_rab10[]       = {192, 168, 30, 10};
    VOS_UINT16                          ausIpV6_rab10[]       = {0x2002, 0, 0, 0, 1, 0, 0x30, 10};

    VOS_UINT8                           aucDnsPrimV4_rab11[]  = {192, 168, 22, 0x21};
    VOS_UINT8                           aucDnsSecV4_rab11[]   = {192, 168, 22, 0x22};
    VOS_UINT16                          ausDnsPrimV6_rab11[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x21};
    VOS_UINT16                          ausDnsSecV6_rab11[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x22};
    VOS_UINT8                           aucIpV4_rab11[]       = {192, 168, 30, 11};
    VOS_UINT16                          ausIpV6_rab11[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 11};

    VOS_UINT8                           aucDnsPrimV4_rab12[]  = {192, 168, 22, 22};
    VOS_UINT8                           aucDnsSecV4_rab12[]   = {192, 168, 22, 32};
    VOS_UINT16                          ausDnsPrimV6_rab12[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x22};
    VOS_UINT16                          ausDnsSecV6_rab12[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x32};
    VOS_UINT8                           aucIpV4_rab12[]       = {192, 168, 30, 12};
    VOS_UINT16                          ausIpV6_rab12[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 12};

    VOS_UINT8                           aucDnsPrimV4_rab13[]  = {192, 168, 22, 23};
    VOS_UINT8                           aucDnsSecV4_rab13[]   = {192, 168, 22, 33};
    VOS_UINT16                          ausDnsPrimV6_rab13[]  = {0x2002, 0, 1, 0, 0, 0, 0x22, 0x23};
    VOS_UINT16                          ausDnsSecV6_rab13[]   = {0x2002, 0, 0, 1, 0, 0, 0x22, 0x33};
    VOS_UINT8                           aucIpV4_rab13[]       = {192, 168, 30, 13};
    VOS_UINT16                          ausIpV6_rab13[]       = {0x2002, 0, 0, 0, 1, 0, 0x30, 13};

    VOS_UINT8                           aucDnsPrimV4_rab14[]  = {192, 168, 22, 0x24};
    VOS_UINT8                           aucDnsSecV4_rab14[]   = {192, 168, 22, 0x34};
    VOS_UINT16                          ausDnsPrimV6_rab14[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x24};
    VOS_UINT16                          ausDnsSecV6_rab14[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x34};
    VOS_UINT8                           aucIpV4_rab14[]       = {192, 168, 30, 14};
    VOS_UINT16                          ausIpV6_rab14[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 14};

    VOS_UINT8                           aucDnsPrimV4_rab15[]  = {192, 168, 22, 55};
    VOS_UINT8                           aucDnsSecV4_rab15[]   = {192, 168, 22, 65};
    VOS_UINT16                          ausDnsPrimV6_rab15[]  = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x55};
    VOS_UINT16                          ausDnsSecV6_rab15[]   = {0x2002, 0, 0, 0, 0, 0, 0x22, 0x65};
    VOS_UINT8                           aucIpV4_rab15[]       = {192, 168, 30, 15};
    VOS_UINT16                          ausIpV6_rab15[]       = {0x2002, 0, 0, 0, 0, 0, 0x30, 15};

    VOS_UINT8                           aucDnsPrimV4_rab16[]  = {192, 168, 22, 56};
    VOS_UINT8                           aucDnsSecV4_rab16[]   = {192, 168, 22, 66};
    VOS_UINT16                          ausDnsPrimV6_rab16[]  = {0x2002, 0, 1, 0, 0, 0, 0x22, 0x56};
    VOS_UINT16                          ausDnsSecV6_rab16[]   = {0x2002, 0, 0, 1, 0, 0, 0x22, 0x66};
    VOS_UINT8                           aucIpV4_rab16[]       = {192, 168, 30, 16};
    VOS_UINT16                          ausIpV6_rab16[]       = {0x2002, 0, 0, 0, 1, 0, 0x30, 16};
...
VOS_VOID ST_DNS_001(VOS_UINT8 ucIpAddr, VOS_UINT8 ucDnsPrim, VOS_UINT8 ucDnsSec)
{
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_DNS_001: config pdn fail! ulResult = %d\n", ulResult);
        return;
    }
...
VOS_VOID ST_DNS_002(VOS_UINT8 ucIpAddr)
{
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_DNS_002: config pdn fail! ulResult = %d\n", ulResult);
        return;
    }
...
VOS_VOID ST_UL_SEND_001(VOS_UINT8 ucIpAddr, VOS_UINT8 ulSendCnt, VOS_UINT32 ulTime)
{
    ...
    if (IMS_NIC_SUCC != ulResult)
    {
        vos_printf("ST_UL_SEND_001: config pdn fail! ulResult = %d\n", ulResult);
        return;
    }
    ...
    if (sock < 0)
    {
        ...
        vos_printf("ST_UL_SEND_001: Get socket failed!\n");
        return;
    }
    ...
    if (ipcom_bind(sock, (struct Ip_sockaddr*) &stInAddr, sizeof(struct Ip_sockaddr)) < 0)
    {
        vos_printf("ST_UL_SEND_001: bind socket failed!\n");
        goto out;
    }
    ...
    for (i = 0; i < ulSendCnt; i++)
    {
        ...
        if ( count !=  s_size)
        {
            vos_printf("ST_UL_SEND_001: ipcom_sendto [%d] count = %d !\n", i, count);
        }
