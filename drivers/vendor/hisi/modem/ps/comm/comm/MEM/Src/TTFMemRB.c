...
#define TTF_MEM_CONNECT_IPC_MEMFREE_INT(a,b,c)       DRV_IPC_INTCONNECT(a,b,c)
#define TTF_MEM_ENABLE_IPC_INT(a)                    DRV_IPC_INTENABLE(a)
#define TTF_MEM_TRIG_IPC_MEMRB_INT(a,b)              DRV_IPC_INTSEND(a,(IPC_INT_LEV_E)(b))
...
VOS_UINT32 TTF_MemRbFreeMsgProc(const MsgBlock *pMsg)
{
    ...
    {
        /* 消息为空告警 */
        TTF_LOG(UEPS_PID_TTF_MEM_RB_FREE, PS_PRINT_WARNING, "TTF_MemRb, TTF_MemRbFreeMsgProc, WARNING, Msg is NULL!\n");
