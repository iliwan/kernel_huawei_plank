...
{
    vos_printf("NAS_UTRANCTRL_RcvWasPowerOffCnf_PowerOff_Init.Entered.\n ");
...
{
    vos_printf("NAS_UTRANCTRL_RcvTdPowerOffCnf_PowerOff_Init.Entered.\n ");
...
{
    vos_printf("NAS_UTRANCTRL_RcvWasPowerOffCnf_PowerOff_WaitWasPowerOffCnf.Entered.\n ");
...
{
    vos_printf("NAS_UTRANCTRL_RcvTdPowerOffCnf_PowerOff_WaitTdPowerOffCnf.Entered.\n ");
