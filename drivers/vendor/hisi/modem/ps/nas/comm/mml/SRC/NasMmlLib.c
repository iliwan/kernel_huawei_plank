...
)
{
    ...
    if (VOS_TRUE == NAS_MML_IsPlmnIdWithRatInDestDisabledPlmnWithValidPeriodList(pstPlmnWithRat,
...
)
{
    ...
    /* 将PLMN加入到禁止接入技术列表里面 */        
    NAS_MML_UpdateDisabledPlmnWithValidPeriodList(pstPlmnWithRat, ulPlmnDisabledExpiredSlice);    
