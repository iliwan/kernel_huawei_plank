...
{
    SMR_SMT_ERROR_NO_ERROR                = 0x0000,

    SMR_SMT_ERROR_STATE_NOT_COMPATIBLE    = 0x0001,

    SMR_SMT_ERROR_NO_SERVICE              = 0x0002,

    SMR_SMT_ERROR_TC1M_TIMEOUT            = 0x0003,

    SMR_SMT_ERROR_TR1M_TIMEOUT            = 0x0004,

    SMR_SMT_ERROR_TR2M_TIMEOUT            = 0x0005,

    SMR_SMT_ERROR_USER_ABORT              = 0x0006,

    SMR_SMT_ERROR_CP_ERROR_BEGIN          = 0x0200,

    SMR_SMT_ERROR_RP_ERROR_BEGIN          = 0x0400,

    SMR_SMT_ERROR_CS_ERROR_BEGIN          = 0x0800,

    SMR_SMT_ERROR_PS_ERROR_BEGIN          = 0x1000,

    SMR_SMT_ERROR_EPS_ERROR_BEGIN         = 0x2000,
