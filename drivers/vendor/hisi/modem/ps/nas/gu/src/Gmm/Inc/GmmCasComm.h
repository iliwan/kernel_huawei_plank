...
VOS_UINT8   GMM_GetTypeFromDetachReqMsg(VOS_UINT8 *pData);
VOS_UINT8   GMM_GetTypeFromIdentityReqMsg(VOS_UINT8 *pData);
VOS_UINT8   GMM_GetCauseFromDetachReqMsg(VOS_UINT8 *pData);
