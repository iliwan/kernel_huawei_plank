...
*****************************************************************************/
/* 打印输出级别定义 */
#define GMM_PRINT_INFO                      PS_PRINT_INFO
#define GMM_PRINT_NORMAL                    PS_PRINT_NORMAL
#define GMM_PRINT_WARNING                   PS_PRINT_WARNING
#define GMM_PRINT_ERROR                     PS_PRINT_ERROR
...
#define GMM_LOG_INFO(String)      \
            PS_LOG(WUEPS_PID_GMM, SUBMOD_NULL, GMM_PRINT_INFO, String)
#define GMM_LOG_NORM(String)      \
            PS_LOG(WUEPS_PID_GMM, SUBMOD_NULL, GMM_PRINT_NORMAL, String)
#define GMM_LOG_WARN(String)      \
            PS_LOG(WUEPS_PID_GMM, SUBMOD_NULL, GMM_PRINT_WARNING, String)
#define GMM_LOG_ERR(String)       \
            PS_LOG(WUEPS_PID_GMM, SUBMOD_NULL, GMM_PRINT_ERROR, String)
