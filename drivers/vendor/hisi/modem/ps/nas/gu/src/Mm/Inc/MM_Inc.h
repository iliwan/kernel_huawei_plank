...
#define MM_LOG(ModulePID, SubMod, Level, String) \
            PS_LOG(WUEPS_PID_MM, VOS_NULL, Level, String)

#define MM_ERR_LOG(String) \
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR, String)

#define MM_WARN_LOG(String) \
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, String)

#define MM_NORM_LOG(String) \
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, String)

#define MM_INFO_LOG(String) \
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, String)

#define MM_NORM_LOG1(String, Para1) \
            PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, String, Para1)
