...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionInitActTbl[]             =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ID_MMA_MMC_ACQ_REQ,
                      NAS_MMC_RcvMmaAcqReq_PlmnSelection_Init),
};
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitCsPsRegRsltIndActTbl[]              =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ...
                      NAS_MMC_RcvMmaImsVoiceCapInd_PlmnSelection_WaitCsPsRegRsltInd),
};
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitMmaRegReqActTbl[]                =
{
    /* 收到 MMA 的 ID_MMA_MMC_REG_REQ 消息的处理 */
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ID_MMA_MMC_REG_REQ,
                      NAS_MMC_RcvMmaRegReq_PlmnSelection_WaitMmaRegReq),

    NAS_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      MMCMMC_ABORT_FSM_REQ,
                      NAS_MMC_RcvMmcAbortFsmMsg_PlmnSelection_WaitMmaRegReq),

    /* 等MMA的注册请求消息超时的处理 */
    NAS_ACT_TBL_ITEM( VOS_PID_TIMER,
                      TI_NAS_MMC_WAIT_MMA_REG_REQ,
                      NAS_MMC_RcvTiWaitMmaRegReqExpired_PlmnSelection_WaitMmaRegReq),

#if   (FEATURE_ON == FEATURE_LTE)
    /* 收到L模的系统消息的处理 */
    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_SYS_INFO_IND,
                      NAS_MMC_RcvLSysInfoInd_PlmnSelection_WaitMmaRegReq),

    /* 收到L模的挂起的处理 */
    NAS_ACT_TBL_ITEM( PS_PID_MM,
                      ID_LMM_MMC_SUSPEND_IND,
                      NAS_MMC_RcvLmmSuspendInd_PlmnSelection_WaitMmaRegReq),

    /* 收到L模的出服务区的处理 */
    NAS_ACT_TBL_ITEM( PS_PID_MM,
                     ID_LMM_MMC_AREA_LOST_IND,
                     NAS_MMC_RcvLmmAreaLostInd_PlmnSelection_WaitMmaRegReq),
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitEpsRegRsltIndActTbl[]         =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ID_MMA_MMC_IMS_VOICE_CAP_IND,
                      NAS_MMC_RcvMmaImsVoiceCapInd_PlmnSelection_WaitEpsRegRsltInd),
...
NAS_ACT_STRU   g_astNasMmcPlmnSelectionWaitEpsRegIndCsPsMode1ReCampLteActTbl[]         =
{
    ...
    NAS_ACT_TBL_ITEM( WUEPS_PID_MMA,
                      ID_MMA_MMC_IMS_VOICE_CAP_IND,
                      NAS_MMC_RcvMmaImsVoiceCapInd_PlmnSelection_WaitEpsRegRsltIndCsPsMode1ReCampLte),
};
...
NAS_STA_STRU g_astNasMmcPlmnSelectionStaTbl[] =
{
    ...
    /*  等待MMA的注册请求 */
    NAS_STA_TBL_ITEM( NAS_MMC_PLMN_SELECTION_STA_WAIT_MMA_REG_REQ,
                          g_astNasMmcPlmnSelectionWaitMmaRegReqActTbl ),
