...
)
{
    ...
    switch (ulEventType)
    {
        ...
        case NAS_BuildEventType(WUEPS_PID_MMA, ID_MMA_MMC_POWER_OFF_REQ):
...
VOS_UINT32  NAS_MMC_InitTask( VOS_VOID )
{
...
)
{
    ...
    */
    ...
    {
        /*lint -e701*/
        ulEventType  = NAS_BuildEventType((VOS_UINT16)pstMsgHeader->ulSenderPid, (VOS_UINT16)pstMsgHeader->ulMsgName);
        /*lint +e701*/
    }
    ...
    {
        NAS_MMC_PostProcessMsg(ulEventType, pstMsg);
    }
...
*****************************************************************************/
VOS_UINT32 NAS_MMC_RegMainL1Fsm( VOS_VOID  )
{
    /* 状态机注册 */
...
VOS_UINT32 NAS_MMC_RegL2Fsm( VOS_VOID  )
{
...
*****************************************************************************/
VOS_UINT32 NAS_MMC_RegPreFsm( VOS_VOID  )
{
    /* 预处理注册 */
