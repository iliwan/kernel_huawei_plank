 ...
 VOS_VOID  NAS_MMC_ReadDplmnNplmnInfoNvim(VOS_VOID)
{
    ...
    {
        NV_GetLength(en_NV_Item_CMCC_Cfg_Dplmn_Nplmn, &ulLen);
        ...
        /* 读NV项en_NV_Item_CMCC_Cfg_Dplmn_Nplmn，失败，直接返回 */
        if (NV_OK != NV_Read(en_NV_Item_CMCC_Cfg_Dplmn_Nplmn,
    ...
    {
        NV_GetLength(en_NV_Item_UNICOM_Cfg_Dplmn_Nplmn, &ulLen);
        ...
        /* 读NV项en_NV_Item_UNICOM_Cfg_Dplmn_Nplmn，失败，直接返回 */
        if (NV_OK != NV_Read(en_NV_Item_UNICOM_Cfg_Dplmn_Nplmn,
                             pstNvimCfgDPlmnNPlmnInfo, ulLen))
        {
            PS_MEM_FREE(WUEPS_PID_MMC, pstNvimCfgDPlmnNPlmnFlag);
            PS_MEM_FREE(WUEPS_PID_MMC, pstNvimCfgDPlmnNPlmnInfo);
    ...
    {
        NV_GetLength(en_NV_Item_CT_Cfg_Dplmn_Nplmn, &ulLen);
        ...
        if (NV_OK != NV_Read(en_NV_Item_CT_Cfg_Dplmn_Nplmn,
                             pstNvimCfgDPlmnNPlmnInfo, ulLen))
        {
            PS_MEM_FREE(WUEPS_PID_MMC, pstNvimCfgDPlmnNPlmnFlag);
            PS_MEM_FREE(WUEPS_PID_MMC, pstNvimCfgDPlmnNPlmnInfo);
...
VOS_VOID NAS_MMC_WriteDplmnNplmnToNvim(VOS_VOID)
{
    ...
    for ( ulStep = 0; ulStep < pstDPlmnNPlmnCfgInfo->usDplmnListNum; ulStep++ )
    {
        ...
        pstNvimCfgDPlmnNPlmnInfo->aucDPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1)]     = stNvimPlmn.aucSimPlmn[0];
        pstNvimCfgDPlmnNPlmnInfo->aucDPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 1] = stNvimPlmn.aucSimPlmn[1];
        pstNvimCfgDPlmnNPlmnInfo->aucDPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 2] = stNvimPlmn.aucSimPlmn[2];
        pstNvimCfgDPlmnNPlmnInfo->aucDPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 3] = (VOS_UINT8)((pstDPlmnNPlmnCfgInfo->astDPlmnList[ulStep].stSimPlmnWithRat.usSimRat) >> NAS_MML_OCTET_MOVE_EIGHT_BITS);
        pstNvimCfgDPlmnNPlmnInfo->aucDPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 4] = (VOS_UINT8)((pstDPlmnNPlmnCfgInfo->astDPlmnList[ulStep].stSimPlmnWithRat.usSimRat) & (0x00FF));

        /* 更新注册域信息 */
        pstNvimCfgDPlmnNPlmnInfo->aucDPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 5] = pstDPlmnNPlmnCfgInfo->astDPlmnList[ulStep].enRegDomain;
    }
    ...
    for ( ulStep = 0; ulStep < pstDPlmnNPlmnCfgInfo->usNplmnListNum; ulStep++ )
    {
        ...
        pstNvimCfgDPlmnNPlmnInfo->aucNPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1)]     = stNvimPlmn.aucSimPlmn[0];
        pstNvimCfgDPlmnNPlmnInfo->aucNPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN +1)  + 1] = stNvimPlmn.aucSimPlmn[1];
        pstNvimCfgDPlmnNPlmnInfo->aucNPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 2] = stNvimPlmn.aucSimPlmn[2];
        pstNvimCfgDPlmnNPlmnInfo->aucNPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 3] = (VOS_UINT8)((pstDPlmnNPlmnCfgInfo->astNPlmnList[ulStep].stSimPlmnWithRat.usSimRat) >> NAS_MML_OCTET_MOVE_EIGHT_BITS);
        pstNvimCfgDPlmnNPlmnInfo->aucNPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 4] = (VOS_UINT8)((pstDPlmnNPlmnCfgInfo->astNPlmnList[ulStep].stSimPlmnWithRat.usSimRat) & (0x00FF));

        /* 更新注册域信息 */
        pstNvimCfgDPlmnNPlmnInfo->aucNPlmnList[ulStep * (NAS_MML_PLMN_WITH_RAT_UNIT_LEN + 1) + 5] = pstDPlmnNPlmnCfgInfo->astNPlmnList[ulStep].enRegDomain;
    }
    ...
    if (NAS_MMC_HPLMN_TYPE_CMCC == ucHplmnType)
    {
        ...
        if (NV_OK != NV_Write(en_NV_Item_CMCC_Cfg_Dplmn_Nplmn,
                              pstNvimCfgDPlmnNPlmnInfo, ulLen))
        {
            PS_MEM_FREE(WUEPS_PID_MMC, pstNvimCfgDPlmnNPlmnInfo);
            return;
    ...
    if (NAS_MMC_HPLMN_TYPE_UNICOM == ucHplmnType)
    {
        ...
        if (NV_OK != NV_Write(en_NV_Item_UNICOM_Cfg_Dplmn_Nplmn,
                              pstNvimCfgDPlmnNPlmnInfo, ulLen))
        {
            PS_MEM_FREE(WUEPS_PID_MMC, pstNvimCfgDPlmnNPlmnInfo);
            return;
    ...
    if (NAS_MMC_HPLMN_TYPE_CT == ucHplmnType)
    {
        ...
        if (NV_OK != NV_Write(en_NV_Item_CT_Cfg_Dplmn_Nplmn,
                              pstNvimCfgDPlmnNPlmnInfo, ulLen))
        {
            PS_MEM_FREE(WUEPS_PID_MMC, pstNvimCfgDPlmnNPlmnInfo);
            return;
