...
VOS_VOID NAS_MMC_LogRplmnRelatedInfo(VOS_VOID)
{
    ...
    /* 获取LTE的RPLMN */
    if (VOS_FALSE == NAS_MML_GetLteRPlmn(&pstMsg->stGetLteRplmn))
    {
        pstMsg->stGetLteRplmn.ulMcc = NAS_MML_INVALID_MCC;
        pstMsg->stGetLteRplmn.ulMnc = NAS_MML_INVALID_MNC;
    }

    /* 获取GU的RPLMN */
    if (VOS_FALSE == NAS_MML_GetGURPlmn(&pstMsg->stGetGuRplmn))
    {
        pstMsg->stGetGuRplmn.ulMcc = NAS_MML_INVALID_MCC;
        pstMsg->stGetGuRplmn.ulMnc = NAS_MML_INVALID_MNC;
    }
