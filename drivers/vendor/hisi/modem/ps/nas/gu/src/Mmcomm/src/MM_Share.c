...
VOS_UINT32 Mm_AtTest_SetPlmnSearchMode(TAF_UINT32 ulPlmnSearchMode)
{
    NAS_NVIM_SELPLMN_MODE_STRU      stPlmnSelMode;

    if ( (ulPlmnSearchMode != 0) && (ulPlmnSearchMode != 1) )
    {
        PS_LOG(WUEPS_PID_MMC, VOS_NULL, PS_PRINT_WARNING, "Mm_AtTest_SetPlmnSearchMode():WARNING: AT^CMM PARA Error!");
        return VOS_ERR;
    }
    ...
    if ( ulPlmnSearchMode == 0 )  /* 自动搜网模式 */
    {
        ...
        if (NV_OK != NV_Write (en_NV_Item_SelPlmn_Mode,
                               &stPlmnSelMode,
                               NV_ITEM_SELPLMN_MODE_SIZE))
        {
            PS_LOG(WUEPS_PID_MMC, VOS_NULL, PS_PRINT_WARNING, "Mm_AtTest_SetPlmnSearchMode():WARNING: Write en_NV_Item_SelPlmn_Mode Error");
            return VOS_ERR;
        }
    }
    else  /* 手动搜网模式 */
...
VOS_UINT32 Mm_AtTest_SetRatMode(TAF_UINT32 ulRatMode)
{
    ...
    {
        PS_LOG(WUEPS_PID_MMC, VOS_NULL, PS_PRINT_WARNING, "Mm_AtTest_SetRatMode():WARNING: AT^CMM PARA Error!");
        return VOS_ERR;
    }
    ...
    {
        PS_LOG(WUEPS_PID_MMC, VOS_NULL, PS_PRINT_WARNING, "Mm_AtTest_SetRatMode():WARNING: Read en_NV_Item_EquivalentPlmn Error");
        return VOS_ERR;
    }
    else
    {   /* 设置接入模式                 */
        ...
        {
            PS_LOG(WUEPS_PID_MMC, VOS_NULL, PS_PRINT_WARNING, "Mm_AtTest_SetRatMode():WARNING: Write en_NV_Item_EquivalentPlmn Error");
            return VOS_ERR;
        }
    }
