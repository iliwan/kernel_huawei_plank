...
#define RABM_LOG_INFO( String )         PS_LOG( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_INFO, String )
#define RABM_LOG_NORMAL( String )       PS_LOG( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_NORMAL, String )
#define RABM_LOG_WARNING( String )      PS_LOG( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_WARNING, String )
#define RABM_LOG_ERROR( String )        PS_LOG( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_ERROR, String )

#define RABM_LOG1_INFO( String, Para1 )        PS_LOG1( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_INFO, String, Para1 )
#define RABM_LOG1_NORMAL( String, Para1 )      PS_LOG1( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_NORMAL, String, Para1 )
#define RABM_LOG1_WARNING( String, Para1 )     PS_LOG1( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_WARNING, String, Para1 )
#define RABM_LOG1_ERROR( String, Para1 )       PS_LOG1( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_ERROR, String, Para1 )

#define RABM_LOG2_INFO( String, Para1, Para2 )        PS_LOG2( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_INFO, String, Para1, Para2 )
#define RABM_LOG2_NORMAL( String, Para1, Para2 )      PS_LOG2( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_NORMAL, String, Para1, Para2 )
#define RABM_LOG2_WARNING( String, Para1, Para2 )     PS_LOG2( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_WARNING, String, Para1, Para2 )
#define RABM_LOG2_ERROR( String, Para1, Para2 )       PS_LOG2( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_ERROR, String, Para1, Para2 )

#define RABM_LOG3_INFO( String, Para1, Para2, Para3 )        PS_LOG3( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_INFO, String, Para1, Para2, Para3 )
#define RABM_LOG3_NORMAL( String, Para1, Para2, Para3 )      PS_LOG3( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_NORMAL, String, Para1, Para2, Para3 )
#define RABM_LOG3_WARNING( String, Para1, Para2, Para3 )     PS_LOG3( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_WARNING, String, Para1, Para2, Para3 )
#define RABM_LOG3_ERROR( String, Para1, Para2, Para3 )       PS_LOG3( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_ERROR, String, Para1, Para2, Para3 )

#define RABM_LOG4_INFO( String, Para1, Para2, Para3, Para4 )        PS_LOG4( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_INFO, String, Para1, Para2, Para3, Para4 )
#define RABM_LOG4_NORMAL( String, Para1, Para2, Para3, Para4 )      PS_LOG4( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_NORMAL, String, Para1, Para2, Para3, Para4 )
#define RABM_LOG4_WARNING( String, Para1, Para2, Para3, Para4 )     PS_LOG4( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_WARNING, String, Para1, Para2, Para3, Para4 )
#define RABM_LOG4_ERROR( String, Para1, Para2, Para3, Para4 )       PS_LOG4( WUEPS_PID_RABM, RABM_SUBMOD_NULL, PS_PRINT_ERROR, String, Para1, Para2, Para3, Para4 )
