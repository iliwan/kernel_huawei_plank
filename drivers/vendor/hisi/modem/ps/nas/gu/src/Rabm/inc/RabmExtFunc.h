...
extern VOS_UINT32  NAS_RabmStartTimer( RABM_TIMER_NAME_ENUM Name, RABM_TIMER_PARA_ENUM Para );
extern VOS_UINT32  NAS_RabmStopTimer( RABM_TIMER_NAME_ENUM Name, RABM_TIMER_PARA_ENUM Para );
...
extern VOS_UINT32  RABM_SetGState(RABM_NSAPI_ENUM  EntId, RABM_2G_STATE_ENUM  DestState);
extern VOS_UINT32  RABM_SetWState(VOS_UINT8    ucEntId, VOS_UINT8   ucDestState);
extern VOS_UINT32  RABM_CreateRabMap
                   (
                       VOS_UINT8 ucRabId,
...
extern VOS_UINT32  RABM_DelRabMap(VOS_UINT8 ucRabId);


extern VOS_UINT32  RABM_ChgRabMap
                   (
                       VOS_UINT8       ucRabId,
...
extern VOS_VOID R_ITF_SetGFlowLev(VOS_VOID);
extern VOS_VOID R_ITF_SetWFlowLev(VOS_VOID);
