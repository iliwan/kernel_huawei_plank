    ...
    for(i = 0; i < pMsg->ulRabCnt; i++)
    {
        ...
        {                                                                       /* 是PS域的RAB                              */
            ...
            case RABM_NSAPI_ACTIVE_PENDING:
                ...
                PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_NORMAL, "RABM_ComSaveRabPara:NORMAL:RABM state: RABM_NSAPI_ACTIVE_PENDING ==> RABM_ACT_PENDING_WITH_RAB");
            ...
            case RABM_NSAPI_ACTIVE_NO_RAB:
                ...
                PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_NORMAL, "RABM_ComSaveRabPara:NORMAL:RABM state: RABM_NSAPI_ACTIVE_NO_RAB ==> RABM_NSAPI_ACTIVE_WITH_RAB");
        ...
        else
        {
            if( NAS_RRC_RAB_SETUP_SUCCESS == pMsg->ulRabChangeType )
            {
                ...
                {
                    PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_WARNING, "RABM_ComSaveRabPara:WARNING:Exceed RABM_CS_MAX_ENT_NUM!");
                    return;
                }
            }
            ucEntId = g_aucSiMapEnt[pMsg->aRabInfo[i].ulRabId];
            ...
            case RABM_NULL:
                ...
                PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_NORMAL, "RABM_ComSaveRabPara:NORMAL:RABM state: RABM_NULL ==> RABM_SI_ACTIVE_WITH_RAB");
    ...
    for(i = 0; i < pMsg->ulRabCnt; i++)
    {
        ...
        {                                                                       /* 是PS域的RAB                              */
            ...
            case RABM_DATA_TRANSFER_STOP:
                ...
                RABM_ChgRabMap(ucEntId + RABM_NSAPI_OFFSET,
                               ...
                               VOS_NULL_PTR,
                               VOS_NULL_PTR);
                PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_NORMAL, "RABM_ComRlsRabReource:NORMAL:RABM state = RABM_NSAPI_ACTIVE_NO_RAB");
            ...
            case RABM_ACT_PENDING_WITH_RAB:
                ...
                PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_NORMAL, "RABM_ComRlsRabReource:NORMAL:RABM state: RABM_ACT_PENDING_WITH_RAB ==> RABM_NSAPI_ACTIVE_PENDING");
                g_aRabmPsEnt[ucEntId].RabInfo.ucRabId = 0xff;                   /* 初始化RAB ID为无效                       */
                g_aRabmPsEnt[ucEntId].RabInfo.ucRbNum = 0;                      /* 初始化RB的个数为0                        */
        ...
        {                                                                       /* 是CS域的RAB                              */
            ...
            case RABM_SI_ACTIVE_WITH_RAB:
                ...
                PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_NORMAL, "RABM_ComRlsRabReource:NORMAL:RABM state: RABM_SI_ACTIVE_WITH_RAB ==> RABM_NULL ");
                    ...
                    )
{
    ...
    {
        PS_LOG(WUEPS_PID_RABM, VOS_NULL, PS_PRINT_WARNING, "Rabm_TcInfSave:WARNING:Rabm_TcInfSave no rab setup ");
    }
