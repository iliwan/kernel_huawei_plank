...
)
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComActPdpCntxtAccCheck:WARNING:NW->SM Invalid mandatory information!");
    ...
    {                                                                           /* 计数器小于消息长度                       */
        if (SM_RETURN_OK != SM_ComOptionalCheck(tempMsg, ulSmPduLen, &ulSum, pMsgIE))               /* 调用函数存储Option项IE                   */
        {
            ...
            PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComActPdpCntxtAccCheck:WARNING:Unknown IE encoded as comprehension required!");
            return SM_NULL;                                                     /* 返回SM_NULL                              */
        }
    }
                                             ...
                                             )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComActPdpCntxtRejCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
    ...
    if( ulSum < ulSmPduLen )
    {                                                                           /* 计数器小于消息长度                       */
        SM_ComOptionalCheck(tempMsg, ulSmPduLen, &ulSum, pMsgIE);               /* 调用函数存储Option项IE                   */
    }
                                                ...
                                                )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComReqPdpCntxtActMsgCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
                                               ...
                                               )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComModifyPdpCntxtAccCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
    tempMsg += 1;                                                               /* 忽略IE"消息类型",更新指针偏移,计数器加1  */
                                               ...
                                               )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComModifyPdpCntxtReqCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
    tempMsg += 1;                                                               /* 忽略IE"消息类型",更新指针偏移,计数器加1  */
    ...
    {                                                                           /* 计数器小于消息长度                       */
        if(SM_RETURN_OK != SM_ComOptionalCheck(tempMsg, ulSmPduLen, &ulSum, pMsgIE))            /* 调用函数存储Option项IE                   */
        {
            ...
            PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComModifyPdpCntxtReqCheck:WARNING:Unknown IE encoded as comprehension required!");
            return SM_NULL;                                                         /* 返回SM_NULL                              */
        }
    }
    else if( ulSum > ulSmPduLen )
                                               ...
                                               )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComActSecPdpCntxtAccCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
                                               ...
                                               )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComActSecPdpCntxtRejCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
    tempMsg += 1;                                                               /* 忽略IE"消息类型",更新指针偏移,计数器加1  */
                                               ...
                                               )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComModifyPdpCntxtRejCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
    tempMsg += 1;                                                               /* 忽略IE"消息类型",更新指针偏移,计数器加1  */
                                              ...
                                              )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComDeActPdpCntxtReqCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
    tempMsg += 1;                                                               /* 忽略IE"消息类型",更新指针偏移,计数器加1  */
                                              ...
                                              )
{
    ...
    {                                                                           /* 消息长度错误                             */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_ComDeActPdpCntxtAccCheck:WARNING:NW->SM Invalid mandatory information!");
        return SM_NULL;                                                         /* 返回SM_NULL                              */
    }
    ulSum += 1;
    tempMsg += 1;                                                               /* 忽略IE"消息类型",更新指针偏移,计数器加1  */
...
VOS_VOID SM_RcvGmmSmStatusInd(
    GMMSM_STATUS_IND_STRU              *pRcvMsg                                 /* 接收到的消息                             */
)
{
    VOS_UINT8                           i;
        ...
        for (i = 0; i < SM_MAX_NSAPI_NUM; i++)
        {
            ...
            {                                                                   /* 当前的状态为SM_PDP_INACTIVE              */
                  ...
                  && (GMM_SM_STATUS_DETACHED == pRcvMsg->ulGmmStatus) )
                {
                    ...
                    /*lint -e701*/
                    g_SmPdpAddrApn.usPdpAddrFlg |= (VOS_UINT16)(0x0001<<ucAddrIndex);
                    /*lint +e701*/
                ...
                else
                {
                    ...
                    PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvGmmSmStatusInd:NORMAL:SM state = SM_PDP_INACTIVE");
...
VOS_VOID SM_RcvGmmSmServiceRej(GMMSM_SERVICE_REJ_STRU  *pRcvMsg)
{
    ...
    for( i = 0; i < SM_MAX_NSAPI_NUM; i++ )
    {
        ...
        {                                                                   /* 当前的状态为SM_PDP_ACTIVE_PENDING */
            ...
            PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvGmmSmServiceRej:NORMAL:SM state = SM_PDP_INACTIVE");
        }
...
VOS_VOID SM_RcvGmmSysInfoInd(GMMSM_SYS_INFO_IND_STRU *pRcvMsg)
{
    ...
    switch (pRcvMsg->ucSgsnRelVer)
    {
                    ...
                    if (SM_PDP_INACTIVE != g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState)
                    {
                              ...
                              && (0 == g_SmEntity.aPdpCntxtList[ucCntxtIndex].QoS.aucQosValue[6]) ) )
                        {
                            ...
                            {                                                                   /* 状态为SM_PDP_INACTIVE_PENDING            */
                                ...
                                PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvGmmSysInfoInd:NORMAL:SM state: SM_PDP_INACTIVE_PENDING ==> SM_PDP_INACTIVE ");
                            }
                            else
                            {
                                ...
                                PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvGmmSysInfoInd:NORMAL: SM state = SM_PDP_INACTIVE");
        ...
        case GMMSM_SGSN_RELEASE99_ONWARDS:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_RcvGmmSysInfoInd:WARNING:ucSgsnRelVer is abnormal!");
            break;
    }
...
VOS_VOID SM_RcvGmmSmPdpStatusInd(GMMSM_PDP_STATUS_IND_STRU *pRcvMsg)
{
    ...
    for( i = 0; i < SM_MAX_NSAPI_NUM; i++ )
    {
        ...
        if ( 0 == ulPdpContextStatus )  /*网侧指示PDP context状态为INACTIVE*/
        {
            ...
            {                                                                   /* 当前的状态不是SM_PDP_INACTIVE              */
                ...
                PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvGmmSmPdpStatusInd:NORMAL:SM state = SM_PDP_INACTIVE");
    ...
    {
        SM_SndGmmPdpStatusInd();                                                /* 通知GMM PDP Context status               */
        NAS_SM_SndGmmPdpDeactivatedInd();                                       /* 向GMM发送GMMSM_PDP_DEACTIVATED_IND消息，报告当前PDP状态 */
    }
...
VOS_VOID SM_RcvNwReqPdpCntxtActMsg(
        ...
        {                                                                       /* 没有发生冲突                             */
            ...
            {                                                                   /* 激活状态                                 */
                ...
                {                                                               /* Ti已使用且APN&PDP addr与另一个PDP
                    ...
                    PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, ":NORMAL: SM state = SM_PDP_INACTIVE");
...
VOS_VOID SM_RcvNwActPdpCntxtAccMsg(
    SM_NW_MSG_STRU                     *pMsgIe                                  /* 收到的消息                               */
)
{
    VOS_UINT8                           ucCntxtIndex;
    ...
    /*可维可测: 接收到PDP ACT ACCEPT的slice值*/
    g_ulSmActAccSlice = OM_GetSlice();
        ...
        == g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState )
    {
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwActPdpCntxtAccMsg:NORMAL: SM state: SM_PDP_ACTIVE_PENDING ==> SM_PDP_ACTIVE");
        SM_SndGmmPdpStatusInd();                                                /* 通知GMM PDP statuc                       */
        NAS_EventReport(WUEPS_PID_SM,
...
VOS_VOID SM_RcvNwActPdpCntxtRejMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    VOS_UINT8                           ucCntxtIndex;
        ...
        == g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState )
    {
        ...
        SM_SndTafSmPdpActivateRej(
            g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucCr,
            NAS_SM_TRANS_SM_NW_CAUSE(pMsgIe->SmCause),
            pProtCfgOpt );
                                                                 /* 向TAF回拒绝消息                          */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwActPdpCntxtRejMsg:NORMAL:SM state: SM_PDP_ACTIVE_PENDING ==> SM_PDP_INACTIVE");
        g_CrMapToNsapi[g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucCr] = 0xff;     /* 维护g_CrMapToNsapi                       */
...
VOS_VOID SM_RcvNwActSecPdpCntxtAccMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    /* VOS_UINT8       ucTi;     A32D00461,zzy,pclint */
    VOS_UINT8       ucCntxtIndex;
        ...
        == g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState )
    {
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwActSecPdpCntxtAccMsg:NORMAL: SM state: SM_PDP_ACTIVE_PENDING ==> SM_PDP_ACTIVE");
        SM_SndGmmPdpStatusInd();                                                /* 通知GMM PDP statuc                       */
    }
    else
    {
...
VOS_VOID SM_RcvNwActSecPdpCntxtRejMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    VOS_UINT8       i,j;
    ...
    {                                                                           /* 状态为SM_PDP_ACTIVE_PENDING              */
        ...
        SM_SndTafSmPdpActSecRej(
          g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucCr,
          NAS_SM_TRANS_SM_NW_CAUSE(pMsgIe->SmCause));                           /* 向TAF回拒绝消息                          */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwActSecPdpCntxtRejMsg:NORMAL:SM state: SM_PDP_ACTIVE_PENDING ==> SM_PDP_INACTIVE");
        g_CrMapToNsapi[g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucCr] = 0xff;     /* 维护g_CrMapToNsapi                       */
        g_TiMapToNsapi[pMsgIe->ucTi] = 0xff;                                    /* 维护g_TiMapToNsapi                       */
    }
    else
...
VOS_VOID SM_RcvNwModifyPdpCntxtReqMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    VOS_UINT8               ucCntxtIndex;
    ...
    else
    {
        ...
        {                                                                       /* 状态为SM_PDP_MODIFY_PENDING              */
            ...
            PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwModifyPdpCntxtReqMsg:NORMAL:SM state: SM_PDP_MODIFY_PENDING ==> SM_PDP_ACTIVE");
        }
        if( SM_PDP_ACTIVE == g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState)
        {                                                                       /* 当前状态为SM_PDP_ACTIVE                  */
            g_SmEntity.aPdpCntxtList[ucCntxtIndex].QoS.ulQosLength
            ...
            PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwModifyPdpCntxtReqMsg:NORMAL: SM state: SM_PDP_ACTIVE ==> SM_PDP_NW_MODIFY");
        }
...
VOS_VOID SM_RcvNwModifyPdpCntxtAccMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    /* VOS_UINT8               ucTi;    A32D00461,zzy,pclint */
        ...
        == g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState )
    {
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwModifyPdpCntxtAccMsg:NORMAL:SM state: SM_PDP_MODIFY_PENDING ==> SM_PDP_ACTIVE");
        NAS_EventReport(WUEPS_PID_SM,
...
VOS_VOID SM_RcvNwModifyPdpCntxtRejMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    /* VOS_UINT8       ucTi;    A32D00461,zzy,pclint */
    ...
    {                                                                           /* 状态为SM_PDP_MODIFY_PENDING              */
        ...
        SM_SndTafSmPdpModifyRej(NAS_SM_TRANS_SM_NW_CAUSE(pMsgIe->SmCause),
            g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucCr);                                            /* 向TAF回拒绝消息                          */
        g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucState = SM_PDP_ACTIVE;         /* 状态切换到SM_PDP_ACTIVE                  */

        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwModifyPdpCntxtRejMsg:NORMAL:SM state: SM_PDP_MODIFY_PENDING ==> SM_PDP_ACTIVE");
        NAS_EventReport(WUEPS_PID_SM,
...
VOS_VOID SM_RcvNwDeActPdpCntxtReqMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    VOS_UINT8               i;
    ...
    if( 0xFF == ucCntxtIndex )
    {                                                                           /* 状态为SM_PDP_INACTIVE                    */
        /*SM_SndStatusMsg(ucTi, TAF_SM_REJ_CAUSE_INVALID_TI);*/                  /* 向network回SM STATUS消息#81              */
    ...
    else
    {
        ...
        {                                                                       /* 包含Tear down indicator IE并且 requested */
            ...
            {                                                                   /* 状态为SM_PDP_INACTIVE_PENDING            */
                ...
                PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwDeActPdpCntxtReqMsg:NORMAL:SM state: SM_PDP_INACTIVE_PENDING ==> SM_PDP_INACTIVE");
                g_TiMapToNsapi[pMsgIe->ucTi] = 0xFF;                            /* 维护g_TiMapToNsapi                       */
            ...
            SM_SndTafSmPdpDeActInd(
                ...
                SM_TRUE);                                                       /* 通知TAF去激活                            */
            /* 绿色通道 */
            ulErrInfo = TAF_OM_GREENCHANNEL_PS_NET_ORIG_DEACTIVE_IND;
            OM_GreenChannel(OM_GREEN_FUNC, TAF_OM_GREEN_CHANNEL_PS, (VOS_UINT8 *)&ulErrInfo, 0);
            ...
            {                                                                   /* Nsapi列表                                */
                ...
                PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwDeActPdpCntxtReqMsg:NORMAL: SM state = SM_PDP_INACTIVE");
...
VOS_VOID SM_RcvNwDeActPdpCntxtAccMsg(
                               SM_NW_MSG_STRU     *pMsgIe                       /* 收到的消息                               */
                               )
{
    VOS_UINT8               ucCntxtIndex;
    ...
    {                                                                           /* 状态为SM_PDP_INACTIVE_PENDING            */
        ...
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwDeActPdpCntxtAccMsg:NORMAL:SM state: SM_PDP_INACTIVE_PENDING ==> SM_PDP_INACTIVE");
        g_TiMapToNsapi[pMsgIe->ucTi] = 0xff;                                    /* 维护g_TiMapToNsapi                       */
        g_CrMapToNsapi[g_SmEntity.aPdpCntxtList[ucCntxtIndex].ucCr] = 0xff;     /* 维护g_CrMapToNsapi                       */
...
VOS_UINT8 SM_ComFindNullAddrApn()
{
    ...
    {                                                                           /* 遍历所有的Addr 和 Apn实体                */
        /*lint -e701*/
        if( 0 == (g_SmPdpAddrApn.usPdpAddrFlg & (0x0001 << i)))
        /*lint +e701*/
        {                                                                       /* 对应的索引没有使用                       */
 ...
 )
{
    ...
    PS_LOG1(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_ComClearPdpCntxt:NORMAL: Destroy SM entity(index):", ucCntxtIndex);
                                 ...
                                 )
{
    ...
    if( 0xFF != ucCr )
    {                                                                           /* 申请 CR成功                              */
        PS_LOG1(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwReqPdpCnxtActMsg_S00:NORMAL: Create SM entity(index):", ucCntxtIndex);
                               ...
                               )
{
    ...
    {
        PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_WARNING, "SM_RcvNwReqPdpCnxtActMsg_S02:WARNING:ucCntxtIndex >= SM_MAX_NSAPI_NUM ");
    ...
    {                                                                           /* 能够比较PDP type, PDP address and APN    */
        ...
        {                                                                       /* PDP type, PDP address and APN相同        */
            ...
            {                                                                   /* Nsapi列表                                */
                ...
                PS_LOG(WUEPS_PID_SM, VOS_NULL, PS_PRINT_NORMAL, "SM_RcvNwReqPdpCnxtActMsg_S02:NORMAL: SM state = SM_PDP_INACTIVE");
