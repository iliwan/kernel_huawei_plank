...
#define SMS_LOG(Level, String) \
           PS_LOG(WUEPS_PID_SMS, 0, Level, String)

#define SMS_LOG1(Level, String, Para1) \
           PS_LOG1(WUEPS_PID_SMS, 0, Level, String, Para1)

#define SMS_LOG2(Level, String, Para1, Para2) \
           PS_LOG2(WUEPS_PID_SMS, 0, Level, String, Para1, Para2)

#define SMS_LOG3(Level, String, Para1, Para2, Para3) \
           PS_LOG3(WUEPS_PID_SMS, 0, Level, String, Para1, Para2, Para3)

#define SMS_LOG4(Level, String, Para1, Para2, Para3, Para4) \
           PS_LOG4(WUEPS_PID_SMS, 0, Level, String, Para1, Para2, Para3, Para4)
