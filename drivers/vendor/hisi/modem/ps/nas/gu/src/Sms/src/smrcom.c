                 ...
                 )
{
    ...
    if (ulLen < 2)
    {                                                                           /* 检查消息过短                             */
        PS_LOG(WUEPS_PID_SMS, VOS_NULL, PS_PRINT_WARNING, "SMR_SmcChk:WARNING:SMR_MSG_TOO_SHORT_ERROR ");
    ...
    case SMR_NTM_DATA_TYPE_RP_DATA:
        ...
        {
            SMS_LOG1(PS_PRINT_ERROR, "SMR_SmcChk:RP DATA ulLen is too short", (VOS_INT32)ulLen);
            return SMR_MSG_TOO_SHORT_ERROR;
        }

        if ((*(pucData+2) < 2)||(*(pucData+2) > 11))
        {
            PS_LOG(WUEPS_PID_SMS, VOS_NULL, PS_PRINT_WARNING, "SMR_SmcChk:WARNING:SMR_ERR_CAUSE_MSG_INVALID_INFO_ERROR ");
    ...
    case SMR_NTM_DATA_TYPE_RP_ACK:
        ...
        {
            SMS_LOG1(PS_PRINT_ERROR, "SMR_SmcChk:RP ACK ulLen is too short", (VOS_INT32)ulLen);
            return SMR_MSG_TOO_SHORT_ERROR;
        }
    ...
    case SMR_NTM_DATA_TYPE_RP_ERR:
        ...
        {
            SMS_LOG1(PS_PRINT_ERROR, "SMR_SmcChk:RP ERROR ulLen is too short", (VOS_INT32)ulLen);
            return SMR_MSG_TOO_SHORT_ERROR;
        }
        ...
        if (usSmsMsgLength > ulLen)
        {                                                                       /* 消息的长度错误                           */
            PS_LOG(WUEPS_PID_SMS, VOS_NULL, PS_PRINT_WARNING, "SMR_SmcChk:WARNING:SMR_ERR_CAUSE_MSG_PROTOCOL_ERROR ");
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_SMS, VOS_NULL, PS_PRINT_WARNING, "SMR_SmcChk:WARNING:SMR_ERR_CAUSE_VALUE_MSG_TYPE_NON_EXIST ");
                       ...
                       )
{
    ...
    {
        PS_LOG(WUEPS_PID_SMS, VOS_NULL, PS_PRINT_WARNING, "SMR_SndRpErrorReq:WARNING:ucMtFlg = SMS_FALSE");
        return;
    }
