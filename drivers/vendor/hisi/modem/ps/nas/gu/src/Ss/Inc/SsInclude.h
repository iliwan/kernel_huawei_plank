...
#define SS_LOG(ModulePID, SubMod, Level, String) \
            PS_LOG(WUEPS_PID_SS, VOS_NULL, Level, String)

#define SS_ERR_LOG(String) \
            PS_LOG(WUEPS_PID_SS, VOS_NULL, PS_PRINT_ERROR, String)

#define SS_WARN_LOG(String) \
            PS_LOG(WUEPS_PID_SS, VOS_NULL, PS_PRINT_WARNING, String)

#define SS_NORM_LOG(String) \
            PS_LOG(WUEPS_PID_SS, VOS_NULL, PS_PRINT_NORMAL, String)

#define SS_INFO_LOG(String) \
            PS_LOG(WUEPS_PID_SS, VOS_NULL, PS_PRINT_INFO, String)

#define SS_WARN_LOG1(String, Para) \
            PS_LOG1(WUEPS_PID_SS, VOS_NULL, PS_PRINT_WARNING, String, Para)

#define SS_NORM_LOG1(String, Para) \
            PS_LOG1(WUEPS_PID_SS, VOS_NULL, PS_PRINT_NORMAL, String, Para)
