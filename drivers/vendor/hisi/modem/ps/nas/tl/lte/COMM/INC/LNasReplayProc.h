...
#define NAS_PC_REPLAY_COMPRESS_DATA_LEN         (120000)                 /* PC回放压缩后的码流长度，单位：字节 */
#else
#define NAS_PC_REPLAY_COMPRESS_DATA_LEN         (12000)
#endif
...
#if 0
#define NAS_REPLAY_MAX_ERABM_UP_DATA_PENDING    10
#define NAS_REPLAY_MAX_LTE_RAT_IS_EXIST     10
#define NAS_REPLAY_MAX_UP_SIGNAL_PENDING    10
#endif
...
enum NAS_OM_LOG_MSG_ID_ENUM
{
    ...
    #if 0
    NAS_ESM_OM_LOG_ISUP_SIG_PENDING_IND,
    NAS_ESM_OM_LOG_LTERAT_EXIST_IND,


    NAS_ERABM_OM_LOG_ISUP_SIG_PENDING_IND,
    #endif
    NAS_OM_LOG_MSG_BUTT
};
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  :BSP_KDF_KeyMake API的导出消息结构
*****************************************************************************/
...
/*****************************************************************************
 ...
 协议表格  :
 ASN.1描述 :
 结构说明  :BSP_KDF_KeyMake API的导入信息结构
*****************************************************************************/
typedef struct
{
    NAS_LMM_BSP_INPUT_PARA_STRU         stBspInputPara;
...
#if 0
/*****************************************************************************
 结构名    : NAS_OM_LOG_ERABM_DATA_PENDING_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :NAS_ERABM_IsDataPending API的导出消息结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
...
} NAS_OM_LOG_ERABM_DATA_PENDING_INFO_STRU;

/*****************************************************************************
 结构名    : NAS_OM_LOG_LTE_RAT_EXIST_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :NAS_EMM_lteRatIsExist API的导出消息结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    VOS_UINT32                          ulMsgName;
    VOS_UINT32                          ulRslt;
} NAS_OM_LOG_LTE_RAT_EXIST_INFO_STRU;

/*****************************************************************************
 结构名    : NAS_OM_LOG_ESM_UPSIG_PENDING_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :NAS_ESM_IsUpSingnalPending API的导出消息结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
...
}NAS_OM_LOG_ESM_UPSIG_PENDING_INFO_STRU;
#endif
/*****************************************************************************
...
extern EMM_ERABM_UP_DATA_PENDING_ENUM_UINT32 g_astErabmUpDataPending[NAS_REPLAY_MAX_ERABM_UP_DATA_PENDING];
extern VOS_UINT32               g_ulErabmUpDataPendingCount;
extern VOS_UINT32               g_ulErabmUpDataPendingIndex;

/*NAS_EMM_lteRatIsExist API导入时的全局变量*/
extern VOS_UINT32  g_astLteRatIsExist[NAS_REPLAY_MAX_LTE_RAT_IS_EXIST];
extern VOS_UINT32               g_ulLteRatIsExistCount;
extern VOS_UINT32               g_ulLteRatIsExistIndex;

/*NAS_ESM_IsUpSingnalPending API导入时的全局变量*/
extern EMM_ESM_UP_SINGNAL_PENDING_ENUM_UINT32 g_astUpSignalPending[NAS_REPLAY_MAX_UP_SIGNAL_PENDING];
extern VOS_UINT32               g_ulUpSignalPendingCount;
extern VOS_UINT32               g_ulUpSignalPendingIndex;
#endif
...
extern VOS_UINT32 NAS_REPLAY_SaveErabmUpDataPending(MsgBlock * pstMsg);
extern VOS_UINT32  Stub_NAS_ERABM_IsDataPending
(
    VOS_VOID
);
extern VOS_UINT32 NAS_REPLAY_SaveLteRatIsExist(MsgBlock * pstMsg);
extern VOS_UINT32  Stub_NAS_EMM_lteRatIsExist
(
    VOS_VOID
);
extern VOS_UINT32 NAS_REPLAY_SaveUpSignalPending(MsgBlock * pstMsg);
extern VOS_UINT32  Stub_NAS_ESM_IsUpSingnalPending
(
    VOS_VOID
);
#endif
