...
/*在RRC_CONN_REL_INIT.WAIT_RRC_REL状态收到RRC_MM_REL_CNF*/
extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelCnfMsgRrcMmRelCnf(VOS_UINT32 ulMsgId, VOS_VOID *pMsgStru);

/*在RRC_CONN_REL_INIT.WAIT_RRC_REL状态收到RRC_MM_REL_IND*/
extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelCnfMsgRrcMmRelInd(VOS_UINT32 ulMsgId, VOS_VOID *pMsgStru);

extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelMsgCnDetatchReq( VOS_UINT32 ulMsgId,  VOS_VOID *pMsgStru );

/*收到释放超时消息*/
extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelMsgTIWaitRrcRelTO(VOS_UINT32 ulMsgId,VOS_VOID *pMsgStru);

/*把RRC连接状态设为连接态*/
extern VOS_VOID  NAS_EMM_ChangeRrcConnStateToEstSignal( VOS_VOID );

extern VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelMsgEsmdataReq
(
...
extern VOS_VOID NAS_EMM_ReattachDelay(VOS_VOID);
