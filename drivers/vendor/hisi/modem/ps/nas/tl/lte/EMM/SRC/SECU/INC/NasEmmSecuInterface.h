...
*****************************************************************************/
#if 0
enum    NAS_EMM_CUR_SECU_STA_ENUM
{
    EMM_CUR_SECU_NOT_EXIST,
    EMM_CUR_SECU_EXIST_NOT_ACTIVE,
    EMM_CUR_SECU_EXIST_ACTIVE,
    EMM_CUR_SECU_STA_BUTT
};
typedef VOS_UINT16 NAS_EMM_CUR_SECU_STA_ENUM_UINT16;

enum    NAS_EMM_NEW_SECU_STA_ENUM
{
    EMM_NEW_SECU_NOT_EXIST,
    EMM_NEW_SECU_EXIST,
    EMM_NEW_SECU_STA_BUTT
};
typedef VOS_UINT16 NAS_EMM_NEW_SECU_STA_ENUM_UINT16;
#endif
...
#if 0
extern VOS_UINT32 NAS_EMM_SndSmcCmpFailProc( VOS_VOID* pMsg);
#endif
