...
/*刷换成需要留出前后流程32字节空挡，避免影响其他内存*/
/*#define NAS_EMM_GetSecuSrcSpace()           ((NAS_EMM_GetSecuCtrlAddr())->aucSrcBuf)*/
/*#define NAS_EMM_GetSecuDstSpace()           ((NAS_EMM_GetSecuCtrlAddr())->aucDstBuf)*/
#define NAS_EMM_GetSecuSrcSpace()           ((NAS_EMM_GetSecuCtrlAddr())->aucSrcBuf + NAS_EMM_CATCH_OP_UINT)
#define NAS_EMM_GetSecuDstSpace()           ((NAS_EMM_GetSecuCtrlAddr())->aucDstBuf + NAS_EMM_CATCH_OP_UINT)
...
extern  VOS_VOID    NAS_EMM_SecuPrintCipherPara(
                                        CIHPER_SINGLE_CFG_S const *pstSingleSecuPara,
...
extern  VOS_UINT32 NAS_EMM_SecuGetKeyByIndex(   VOS_UINT32      ulKeyIndex,
                                                KEY_GET_S      *pstKeyGet);
extern  VOS_INT32   NAS_CIPHER_SingleSubmitTask( VOS_UINT8 const *pucSrcAddr,
