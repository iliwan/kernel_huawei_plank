...
#define NAS_ESM_SavePdnAddr(pstEpsPdnAddr, pstPdpPdnAddr)\
            {\
                ...
                NAS_ESM_MEM_CPY((pstEpsPdnAddr)->aucIpV4Addr, (pstPdpPdnAddr)->aucIpV4Addr, APP_MAX_IPV4_ADDR_LEN);\
                NAS_ESM_MEM_CPY((pstEpsPdnAddr)->aucIpV6Addr, (pstPdpPdnAddr)->aucIpV6Addr, APP_MAX_IPV6_ADDR_LEN);\
            }

#define NAS_ESM_SaveApnAddr(pstEpsApnAddr, pstPdpApnAddr)\
            {\
                (pstEpsApnAddr)->ucApnLen = (pstPdpApnAddr)->ucLength;\
                NAS_ESM_MEM_CPY((pstEpsApnAddr)->aucApnName, (pstPdpApnAddr)->aucValue, APP_MAX_APN_LEN);\
            }
