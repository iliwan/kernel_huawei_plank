...
#define IMSA_CALL_TIMER_LEN_WAIT_RES    (120*1000)
#endif
...
extern VOS_VOID IMSA_CallProcTimeoutCMCCTCall(const VOS_VOID *pTimerMsg);
extern VOS_VOID IMSA_StartCMCCTcallTimer(const IMSA_CALL_ENTITY_STRU *pstCallEntity);
