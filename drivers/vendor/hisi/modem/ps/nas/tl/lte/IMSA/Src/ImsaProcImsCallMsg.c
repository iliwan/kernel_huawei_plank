...
)
{
    ...
    if (((IMSA_TRUE == pstCallCtx->ulIsVoiceMediaPdpReady) && (IMSA_CALL_TYPE_VOICE == pstCallEntity->enType))
        || ((IMSA_TRUE == pstCallCtx->ulIsVideoMediaPdpReady) && (IMSA_CALL_TYPE_VIDEO == pstCallEntity->enType))
    ...
    if  (VOS_TRUE == IMSA_GetConfigParaAddress()->stCMCCCustomReq.ucCMCCCustomTqosFlag)
    {
        ...
        {
            if ((IMSA_FALSE == pstCallCtx->ulIsVideoMediaPdpReady) &&
                (IMSA_TRUE == pstCallCtx->ulIsVoiceMediaPdpReady))
            {
...
)
{
            ...
            && VOS_TRUE == pstCallCtx->ucIsCmccTcallTimeOutProc)
    {
        ...
        pstCallCtx->ucIsCmccTcallTimeOutProc = VOS_FALSE;
            ...
            && (IMSA_FALSE == pstCallEntity->bitOpResReady)
