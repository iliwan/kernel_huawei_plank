...
#define NAS_EMMC_SetSinglePlmnSrchFlag(Flag)        (((NAS_EMMC_GetEmmcInfoAddr())->ulSinglePlmnSrchFlag) = (Flag))
#define NAS_EMMC_GetSinglePlmnSrchFlag()            ((NAS_EMMC_GetEmmcInfoAddr())->ulSinglePlmnSrchFlag)
...
typedef struct
{
    ...
    VOS_UINT32                          ulSinglePlmnSrchFlag;
