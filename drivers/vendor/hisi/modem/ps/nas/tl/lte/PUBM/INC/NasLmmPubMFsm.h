...
/* LMM上报给MMC服务状态的宏定义 */
#define NAS_LMM_GetNasMmcServiceState()             (NAS_LMM_GetMmAuxFsmAddr()->enNasMmcServiceState)
#define NAS_LMM_SetNasMmcServiceState(ServiceState) (NAS_LMM_GetMmAuxFsmAddr()->enNasMmcServiceState = ServiceState)
/* LMM上报给MMC的CS服务状态宏定义*/
#define NAS_LMM_GetNasMmcCSServiceState()               (NAS_LMM_GetMmAuxFsmAddr()->enNasMmcCSServiceState)
#define NAS_LMM_SetNasMmcCSServiceState(CSServiceState) (NAS_LMM_GetMmAuxFsmAddr()->enNasMmcCSServiceState = CSServiceState)


/* LMM上报给MMC注册状态的宏定义*/
#define NAS_LMM_GetNasMmcRegisterState()            (NAS_LMM_GetMmAuxFsmAddr()->enNasMmcRegisterState)
#define NAS_LMM_SetNasMmcRegisterState(RegState)    (NAS_LMM_GetMmAuxFsmAddr()->enNasMmcRegisterState = RegState)

/* LMM因REJ CAUSE 12的标志的宏定义*/
#define NAS_LMM_GetNasRejCause12Flag()              (NAS_LMM_GetMmAuxFsmAddr()->ulEmmRejCause12Flag)
#define NAS_LMM_SetNasRejCause12Flag(Rej12State)    (NAS_LMM_GetMmAuxFsmAddr()->ulEmmRejCause12Flag = Rej12State)
...
typedef struct
{
    ...
    MMC_LMM_SERVICE_STATUS_ENUM_UINT32  enNasMmcServiceState; /* 上报给MMC的服务状态*/
    MMC_LMM_SERVICE_STATUS_ENUM_UINT32  enNasMmcCSServiceState; /* 上报给MMC的CS域服务状态,add by FTY 2012-01-11*/
    MMC_LMM_REGISTER_STATUS_ENUM_UINT32 enNasMmcRegisterState; /* 上报给MMC的注册状态 */
    NAS_LMM_CUR_LTE_STATE_ENUM_UINT32   ulCurLteState;
    VOS_UINT32                          ulEmmRejCause12Flag;
...
extern MMC_LMM_SERVICE_STATUS_ENUM_UINT32  NAS_LMM_DeregServiceStateMap(
                                        const NAS_EMM_FSM_STATE_STRU        *pstEmmDestState);
extern MMC_LMM_SERVICE_STATUS_ENUM_UINT32  NAS_LMM_RegServiceStateMap(
                                        const NAS_EMM_FSM_STATE_STRU        *pstEmmDestState);
/*extern VOS_VOID  NAS_EMM_SendMmcServiceStatInd( MMC_LMM_SERVICE_STATUS_ENUM_UINT32   ulNasMmcSerivceState);*/
extern VOS_VOID  NAS_EMM_SendMmcServiceStatInd( MMC_LMM_SERVICE_STATUS_ENUM_UINT32   ulNasMmcCSSerivceState,
                                        MMC_LMM_SERVICE_STATUS_ENUM_UINT32   ulNasMmcPSSerivceState);

extern VOS_VOID NAS_LMM_CovertMmlRegStatusToLmmRegStatus
                (NAS_MML_REG_STATUS_ENUM_UINT8 enMmlRegStatus, MMC_LMM_REGISTER_STATUS_ENUM_UINT32 *penLmmRegState);

extern VOS_VOID  NAS_EMM_SendMmcRegisterStatInd(NAS_EMM_REG_CHANGE_TYPE_ENUM_UINT32 ulChangeType);

extern MMC_LMM_SERVICE_STATUS_ENUM_UINT32  NAS_LMM_ServiceStateMap(
                                        const NAS_EMM_FSM_STATE_STRU        *pstEmmDestState);
extern MMC_LMM_SERVICE_STATUS_ENUM_UINT32  NAS_LMM_CSServiceStateMap(
                                        const NAS_EMM_FSM_STATE_STRU        *pstEmmDestState);

extern VOS_VOID  NAS_LMM_MmcServiceStateChange( NAS_EMM_FSM_STATE_STRU  stEmmDestState);
extern MMC_LMM_REGISTER_STATUS_ENUM_UINT32  NAS_LMM_RegRegisterStateMap(
                                        const NAS_EMM_FSM_STATE_STRU        *pstEmmDestState);
extern MMC_LMM_REGISTER_STATUS_ENUM_UINT32  NAS_LMM_DeregRegisterStateMap(
                                        const NAS_EMM_FSM_STATE_STRU         *pstEmmDestState);
extern MMC_LMM_REGISTER_STATUS_ENUM_UINT32  NAS_LMM_RegisterStateMap(
                                        const NAS_EMM_FSM_STATE_STRU         *pstEmmDestState);
extern VOS_VOID  NAS_LMM_MmcRegisterStateChange( NAS_EMM_FSM_STATE_STRU  stEmmDestState);
