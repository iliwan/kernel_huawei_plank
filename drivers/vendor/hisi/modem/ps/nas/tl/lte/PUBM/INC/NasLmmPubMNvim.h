...
typedef struct
{
    ...
    NAS_USIM_FILE_ID_ENUM_UINT16        usUsimFileId;       /* USIM协议文件ID */
...
extern VOS_UINT32  NAS_LMM_NvimRead(  NAS_LMM_ITEM_TYPE_ENUM_UINT32 ulNVItemType,
                                    VOS_VOID *pData,
...
extern VOS_UINT32 NAS_LMM_ProcessHardUsimCnf(PS_USIM_GET_FILE_CNF_STRU * pstUsimFileCnf);
/*extern VOS_VOID   NAS_LMM_DoAfterReadManOrOptFileOver(VOS_VOID);*/
extern VOS_VOID   NAS_LMM_DoAfterReadOptFileOver( VOS_VOID );

extern VOS_UINT32  NAS_LMM_ReadMmcUsimFile(VOS_VOID);
