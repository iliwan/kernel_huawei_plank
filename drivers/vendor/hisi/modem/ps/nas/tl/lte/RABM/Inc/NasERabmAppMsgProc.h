...
extern APP_ERABM_TRANSFER_RESULT_ENUM_UINT32 Nas_DataReq( VOS_UINT32 ulDataLen, LUP_MEM_ST *pstSdu );
#endif
...
extern  VOS_VOID  NAS_ERABM_SndRabmAppDataCnf( const NAS_ERABM_APP_DATA_TRANS_SET_RESLT_STRU
                                                             *pstRabmAppDataTrans );
#if 0
extern VOS_VOID  NAS_ERABM_RcvRabmAppServiceReq
(
    APP_ERABM_SERVICE_REQ_STRU          *pstServiceReq
);
extern VOS_VOID  NAS_ERABM_SndAppRabmServiceReq( VOS_VOID );

extern APP_ERABM_TRANSFER_RESULT_ENUM_UINT32 TC_DataReq
(
    VOS_UINT32                          ulDataLen,
    LUP_MEM_ST                         *pstSdu,
    VOS_UINT32                          ulEpsbId
...
/* for test*/
extern VOS_UINT32  NAS_ERABM_EpsBearLinkedDrbSuspendedProc
(
    LUP_MEM_ST                         *pstSdu,
    VOS_UINT32                          ulEpsbId
);
extern VOS_UINT32  NAS_ERABM_EpsBearLinkedDrbNotExistProc
(
    LUP_MEM_ST                         *pstSdu,
    VOS_UINT32                          ulEpsbId
);
