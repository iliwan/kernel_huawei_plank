...
VOS_VOID MTC_DEBUG_TraceAllModemConnStateInfo(VOS_VOID)
{
   ...
   for (enModemID = 0; enModemID < MODEM_ID_BUTT; enModemID++)
   {
        stAllModemState.stModemStateInfo[enModemID].enIsCsSrvConnExist  = MTC_GetCsConnStateInfo(enModemID);
        stAllModemState.stModemStateInfo[enModemID].enIsPsSrvConnExist  = MTC_GetPsConnStateInfo(enModemID);
   ...
   /* 外置modem状态信息 */
   stAllModemState.stModemStateInfo[enModemID].enIsCsSrvConnExist  = MTC_GetOutSideCsConnStateInfo(MTC_OUTSIDE_MODEM_CDMA);
   stAllModemState.stModemStateInfo[enModemID].enIsPsSrvConnExist  = MTC_GetOutSidePsConnStateInfo(MTC_OUTSIDE_MODEM_CDMA);
   stAllModemState.stModemStateInfo[enModemID].enPowerState        = MTC_GetOutSideModemPowerState(MTC_OUTSIDE_MODEM_CDMA);
   stAllModemState.stModemStateInfo[enModemID].enUsimmState        = MTC_GetOutSideModemUsimmState(MTC_OUTSIDE_MODEM_CDMA);
