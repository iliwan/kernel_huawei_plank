...
#else
#define XML_WARNING_LOG(string)                 PS_LOG(WUEPS_PID_TAF, 0, PS_PRINT_WARNING,  string)
#define XML_WARNING1_LOG(string, para1)         PS_LOG1(WUEPS_PID_TAF, 0, PS_PRINT_WARNING,  string, (VOS_INT32)para1)
#define XML_WARNING2_LOG(string, para1, para2)  PS_LOG2(WUEPS_PID_TAF, 0, PS_PRINT_WARNING,  string, (VOS_INT32)para1, (VOS_INT32)para2)
#define XML_ERROR_LOG(string)                   PS_LOG(WUEPS_PID_TAF, 0, PS_PRINT_ERROR,  string)
#define XML_ERROR1_LOG(string, para1)           PS_LOG1(WUEPS_PID_TAF, 0, PS_PRINT_ERROR,  string, (VOS_INT32)para1)
#define XML_ERROR2_LOG(string, para1, para2)    PS_LOG2(WUEPS_PID_TAF, 0, PS_PRINT_ERROR,  string, (VOS_INT32)para1, (VOS_INT32)para2)
#endif
