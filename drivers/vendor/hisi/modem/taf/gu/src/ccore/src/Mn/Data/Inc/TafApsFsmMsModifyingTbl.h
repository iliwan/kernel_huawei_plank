...
enum TAF_APS_MS_MODIFYING_SUBSTA_ENUM
{
    ...
    TAF_APS_MS_MODIFYING_SUBSTA_WAIT_L4A_MODIFY_CNF,                            /* APS向L4A发起了PDP修改请求，等待L4A响应 */
    TAF_APS_MS_MODIFYING_SUBSTA_WAIT_L4A_MODIFY_CNF_SUSPEND,                    /* APS向L4A发起了PDP修改请求，等待L4A响应时被挂起 */
#endif
