...
/*****************************************************************************
  10 函数声明
*****************************************************************************/
extern VOS_UINT32  TAF_APS_InitTask( VOS_VOID );
...
extern VOS_UINT32 TAF_APS_RegMainFsm( VOS_VOID  );


extern VOS_UINT32 TAF_APS_RegSubFsm( VOS_VOID  );


extern VOS_UINT32 TAF_APS_RegPreFsm( VOS_VOID  );
...
extern VOS_UINT32  TAF_APS_PostProcessMsg(
    VOS_UINT32                          ulEventType,
    struct MsgCB                       *pstMsg
);
