...
#define TAF_PS_INFO_LOG(String)         PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_INFO, String)
#define TAF_PS_NORM_LOG(String)         PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_NORMAL, String)
#define TAF_PS_WARN_LOG(String)         PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_WARNING, String)
#define TAF_PS_ERR_LOG(String)          PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_ERROR, String)
