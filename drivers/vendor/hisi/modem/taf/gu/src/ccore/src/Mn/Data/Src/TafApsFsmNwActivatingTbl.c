...
TAF_ACT_STRU   g_astTafApsNwActivatingSubStaWaitAppAnswerActTbl[]   =
{
    ...
    TAF_ACT_TBL_ITEM(WUEPS_PID_MMC,
                     ...
                     TAF_APS_RcvMmcServiceStatusInd_NwActivating_WaitAppAnswer),
...
TAF_ACT_STRU   g_astTafApsNwActivatingSubStaWaitSmCnfActTbl[]   =
{
    ...
    TAF_ACT_TBL_ITEM(WUEPS_PID_MMC,
                     ID_MMC_APS_SERVICE_STATUS_IND,
                     TAF_APS_RcvMmcServiceStatusInd_NwActivating_WaitSmActivateCnf),
...
TAF_ACT_STRU g_astTafApsNwActivatingSubStaWaitL4aCgansActTbl[] =
{
    ...
    TAF_ACT_TBL_ITEM(WUEPS_PID_MMC,
                     ID_MMC_APS_SERVICE_STATUS_IND,
                     TAF_APS_RcvMmcServiceStatusInd_NwActivating_WaitL4aCgansCnf),
...
TAF_ACT_STRU   g_astTafApsNwActivatingSubStaWaitSndcpActivateRspActTbl[]   =
{
    ...
    TAF_ACT_TBL_ITEM(WUEPS_PID_MMC,
                     ID_MMC_APS_SERVICE_STATUS_IND,
                     TAF_APS_RcvMmmcServiceStatusInd_NwActivating_WaitSndcpActivateRsp),
