...
VOS_VOID  MN_MSG_ReadSmsPpDownloadSupportFlgNvim( VOS_VOID )
{
    ...
    stSmsPpDownlodSupportFlg.ucReserved               = 0;


    pstMsCfgInfo = MN_MSG_GetCustomCfgInfo();
    
    NV_GetLength(en_NV_Item_NVIM_SMS_PP_DOWNLOAD_SUPPORT_FLG, &ulLength);	
...
VOS_VOID  MN_MSG_GetFalshSmsStoragePath( VOS_VOID )
{
    ...
    {
        MN_WARN_LOG("MN_MSG_GetFalshSmsStoragePath():WARNING: en_NV_Item_ProductTypeForLogDirectory Error");
...
VOS_VOID  MN_MSG_ReadSmsNvimSmsRexistSupportFlgNvim( VOS_VOID )
{
    ...
    stSmsNvSmsrexitSupportFlg.ucReserved                = 0;
    

    pstMsCfgInfo = MN_MSG_GetCustomCfgInfo();
    
    NV_GetLength(en_NV_Item_NVIM_SMS_NVIM_SMSREXIST_SUPPORT_FLG, &ulLength);	
...
VOS_VOID  MN_MSG_ReadSmsStatusReportInEfsmsSupportFlgNvim( VOS_VOID )
{
    ...
    stSmsStatusInEfsmsSupportFlg.ucReserved                   = 0;
    

    pstMsCfgInfo = MN_MSG_GetCustomCfgInfo();
    
    NV_GetLength(en_NV_Item_NVIM_SMS_STATUS_REPORT_IN_EFSMS_SUPPORT_FLG, &ulLength);	
...
VOS_VOID  MN_MSG_ReadPsOnlyCsServiceSupportFlgNvim( VOS_VOID )
{
    ...
    stPsOnlyCsServiceSupportFlg.ucReserved                  = 0;
