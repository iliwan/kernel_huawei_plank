...
VOS_UINT32  SSA_DecodeMsisdn(VOS_UINT8                          *pucMsisdn,
                             VOS_UINT8                         **pucSrc,
                             TAG_MODE                            ucTagmode);
VOS_UINT32  SSA_DecodeAlertingPattern(TAF_SS_ALERTINGPATTERN    *pucAlertingPattern,
                                      VOS_UINT8                **pucSrc,
                                      TAG_MODE                   ucTagmode);
...
VOS_UINT32  SSA_DecodeUssdString(TAF_SS_USSD_STRING_STRU                    *pDest,
                                 VOS_UINT8                                 **pucSrc,
                                 TAG_MODE                                    ucTagMode);
VOS_UINT32 SSA_Decode7bit (TAF_SS_USSD_STRING_STRU   *para, VOS_UINT8  ucCodingScheme);
