...
)
{
    ...
    /* 调用底软的设置gpio和mipi函数 */
    ulResult = (VOS_UINT32)mdrv_fem_ioctrl((FEMIO_CTRL_TYPE)pstFemctrl->ulCtrlType, pstFemctrl->ulPara1, pstFemctrl->ulPara2, pstFemctrl->ulPara3);
