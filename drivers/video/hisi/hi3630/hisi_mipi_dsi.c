...
static ssize_t mipi_dsi_amoled_acl_show(struct platform_device *pdev, char *buf)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
...
static ssize_t mipi_dsi_amoled_acl_store(struct platform_device *pdev,
	const char *buf, size_t count)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
...
static ssize_t mipi_dsi_amoled_hbm_store(struct platform_device *pdev,
	const char *buf, size_t count)
{
	ssize_t ret = 0;
	struct hisi_fb_data_type *hisifd = NULL;
